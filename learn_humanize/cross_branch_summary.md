...
```text
complete: 33
prepared_not_complete: 6
```

## Current Next Branches Needing Worker Completion

`humanize/skillize-rlcr-actions`, `humanize/templify-prompt`, `humanize/todo2task-careful-mode`, `humanize/tunable-full-examine-round`, `humanize/use-realpath4everything`, `humanize/vcs-cli-on-plan-file`
