...
```text
complete: 19
prepared_not_complete: 20
```

## Current Next Branches Needing Worker Completion

`humanize/feature/codex-bypass-sandbox-env`, `humanize/fix-humanize-escape`, `humanize/fix-pr-loop`, `humanize/fix-too-strict-rule-and-enhance-plan-gen`, `humanize/general-refactor-and-review`, `humanize/general-robustness-edge-test`, `humanize/impl-dccb-loop`, `humanize/impl-pr-loop`, `humanize/improve-gen-plan-command`, `humanize/improve-monitor-script`, ... (20 total incomplete)
