...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-009 | directory | `prompt-template/block` | 10276 | directory contains included core algorithm descendant(s) |
| CANCEL_WHEN_FINALIZE-HZ-039 | file | `hooks/lib/loop-common.sh` | 18577 | hook or validator implementation for the RLCR state machine |
| CANCEL_WHEN_FINALIZE-HZ-069 | file | `prompt-template/claude/next-round-footer.md` | 465 | prompt/block template defining algorithmic transitions, gates, or review contracts |
