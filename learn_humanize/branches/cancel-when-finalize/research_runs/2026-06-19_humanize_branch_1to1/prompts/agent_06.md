...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-006 | directory | `tests` | 227063 | directory contains included core algorithm descendant(s) |
| CANCEL_WHEN_FINALIZE-HZ-036 | file | `tests/test-template-references.sh` | 7095 | executable specification for core algorithm behavior |
| CANCEL_WHEN_FINALIZE-HZ-066 | file | `prompt-template/block/wrong-summary-location.md` | 109 | prompt/block template defining algorithmic transitions, gates, or review contracts |
