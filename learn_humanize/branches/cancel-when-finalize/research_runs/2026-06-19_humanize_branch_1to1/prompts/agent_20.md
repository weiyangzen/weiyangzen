...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-020 | file | `hooks/loop-read-validator.sh` | 4633 | hook or validator implementation for the RLCR state machine |
| CANCEL_WHEN_FINALIZE-HZ-050 | file | `prompt-template/block/goal-tracker-not-initialized.md` | 707 | prompt/block template defining algorithmic transitions, gates, or review contracts |
