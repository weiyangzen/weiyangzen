...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-007 | file | `README.md` | 9596 | behavior-defining documentation for workflow/state-machine algorithms |
| CANCEL_WHEN_FINALIZE-HZ-037 | file | `tests/test-templates-comprehensive.sh` | 19978 | executable specification for core algorithm behavior |
| CANCEL_WHEN_FINALIZE-HZ-067 | file | `prompt-template/claude/finalize-phase-prompt.md` | 1650 | prompt/block template defining algorithmic transitions, gates, or review contracts |
