...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-002 | directory | `commands` | 5465 | directory contains included core algorithm descendant(s) |
| CANCEL_WHEN_FINALIZE-HZ-032 | file | `tests/test-plan-file-hooks.sh` | 34778 | executable specification for core algorithm behavior |
| CANCEL_WHEN_FINALIZE-HZ-062 | file | `prompt-template/block/wrong-directory-path.md` | 152 | prompt/block template defining algorithmic transitions, gates, or review contracts |
