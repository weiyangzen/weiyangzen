...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-025 | file | `tests/run-all-tests.sh` | 2772 | executable specification for core algorithm behavior |
| CANCEL_WHEN_FINALIZE-HZ-055 | file | `prompt-template/block/prompt-file-write.md` | 413 | prompt/block template defining algorithmic transitions, gates, or review contracts |
