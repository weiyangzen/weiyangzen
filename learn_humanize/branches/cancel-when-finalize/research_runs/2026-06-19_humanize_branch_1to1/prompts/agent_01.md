...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-001 | directory | `.` | 432861 | directory contains included core algorithm descendant(s) |
| CANCEL_WHEN_FINALIZE-HZ-031 | file | `tests/test-finalize-phase.sh` | 23200 | executable specification for core algorithm behavior |
| CANCEL_WHEN_FINALIZE-HZ-061 | file | `prompt-template/block/work-summary-missing.md` | 335 | prompt/block template defining algorithmic transitions, gates, or review contracts |
