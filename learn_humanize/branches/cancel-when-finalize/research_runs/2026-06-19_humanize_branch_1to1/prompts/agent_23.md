...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-023 | file | `scripts/portable-timeout.sh` | 2116 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| CANCEL_WHEN_FINALIZE-HZ-053 | file | `prompt-template/block/plan-backup-protected.md` | 259 | prompt/block template defining algorithmic transitions, gates, or review contracts |
