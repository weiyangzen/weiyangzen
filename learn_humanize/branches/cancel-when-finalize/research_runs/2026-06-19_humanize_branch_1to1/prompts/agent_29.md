...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-029 | file | `tests/test-cancel-signal-file.sh` | 41224 | executable specification for core algorithm behavior |
| CANCEL_WHEN_FINALIZE-HZ-059 | file | `prompt-template/block/todos-file-access.md` | 253 | prompt/block template defining algorithmic transitions, gates, or review contracts |
