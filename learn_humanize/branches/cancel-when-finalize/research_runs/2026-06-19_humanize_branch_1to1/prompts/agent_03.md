...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-003 | directory | `hooks` | 110576 | directory contains included core algorithm descendant(s) |
| CANCEL_WHEN_FINALIZE-HZ-033 | file | `tests/test-plan-file-validation.sh` | 22731 | executable specification for core algorithm behavior |
| CANCEL_WHEN_FINALIZE-HZ-063 | file | `prompt-template/block/wrong-file-location.md` | 318 | prompt/block template defining algorithmic transitions, gates, or review contracts |
