...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-018 | file | `hooks/loop-edit-validator.sh` | 4887 | hook or validator implementation for the RLCR state machine |
| CANCEL_WHEN_FINALIZE-HZ-048 | file | `prompt-template/block/goal-tracker-bash-write.md` | 289 | prompt/block template defining algorithmic transitions, gates, or review contracts |
