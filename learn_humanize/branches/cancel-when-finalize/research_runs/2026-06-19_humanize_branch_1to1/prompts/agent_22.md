...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-022 | file | `scripts/humanize.sh` | 29644 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| CANCEL_WHEN_FINALIZE-HZ-052 | file | `prompt-template/block/large-files.md` | 1088 | prompt/block template defining algorithmic transitions, gates, or review contracts |
