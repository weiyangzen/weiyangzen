...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-005 | directory | `scripts` | 56399 | directory contains included core algorithm descendant(s) |
| CANCEL_WHEN_FINALIZE-HZ-035 | file | `tests/test-template-loader.sh` | 21290 | executable specification for core algorithm behavior |
| CANCEL_WHEN_FINALIZE-HZ-065 | file | `prompt-template/block/wrong-round-number.md` | 225 | prompt/block template defining algorithmic transitions, gates, or review contracts |
