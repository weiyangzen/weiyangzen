...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-017 | file | `hooks/loop-codex-stop-hook.sh` | 40784 | hook or validator implementation for the RLCR state machine |
| CANCEL_WHEN_FINALIZE-HZ-047 | file | `prompt-template/block/git-status-failed.md` | 326 | prompt/block template defining algorithmic transitions, gates, or review contracts |
