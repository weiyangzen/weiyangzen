...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-004 | directory | `prompt-template` | 23762 | directory contains included core algorithm descendant(s) |
| CANCEL_WHEN_FINALIZE-HZ-034 | file | `tests/test-state-exit-naming.sh` | 8959 | executable specification for core algorithm behavior |
| CANCEL_WHEN_FINALIZE-HZ-064 | file | `prompt-template/block/wrong-round-file.md` | 343 | prompt/block template defining algorithmic transitions, gates, or review contracts |
