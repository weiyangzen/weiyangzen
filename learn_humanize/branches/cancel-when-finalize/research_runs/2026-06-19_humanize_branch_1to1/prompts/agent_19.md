...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-019 | file | `hooks/loop-plan-file-validator.sh` | 7830 | hook or validator implementation for the RLCR state machine |
| CANCEL_WHEN_FINALIZE-HZ-049 | file | `prompt-template/block/goal-tracker-modification.md` | 792 | prompt/block template defining algorithmic transitions, gates, or review contracts |
