...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-008 | directory | `hooks/lib` | 25691 | directory contains included core algorithm descendant(s) |
| CANCEL_WHEN_FINALIZE-HZ-038 | file | `tests/test-todo-checker.sh` | 10313 | executable specification for core algorithm behavior |
| CANCEL_WHEN_FINALIZE-HZ-068 | file | `prompt-template/claude/goal-tracker-update-request.md` | 573 | prompt/block template defining algorithmic transitions, gates, or review contracts |
