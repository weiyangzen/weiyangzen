...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-021 | file | `hooks/loop-write-validator.sh` | 7667 | hook or validator implementation for the RLCR state machine |
| CANCEL_WHEN_FINALIZE-HZ-051 | file | `prompt-template/block/incomplete-todos.md` | 442 | prompt/block template defining algorithmic transitions, gates, or review contracts |
