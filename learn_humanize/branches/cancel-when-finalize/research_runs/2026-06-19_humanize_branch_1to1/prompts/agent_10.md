...
|---|---|---:|---:|---|
| CANCEL_WHEN_FINALIZE-HZ-010 | directory | `prompt-template/claude` | 4385 | directory contains included core algorithm descendant(s) |
| CANCEL_WHEN_FINALIZE-HZ-040 | file | `hooks/lib/template-loader.sh` | 7114 | hook or validator implementation for the RLCR state machine |
| CANCEL_WHEN_FINALIZE-HZ-070 | file | `prompt-template/claude/next-round-prompt.md` | 1206 | prompt/block template defining algorithmic transitions, gates, or review contracts |
