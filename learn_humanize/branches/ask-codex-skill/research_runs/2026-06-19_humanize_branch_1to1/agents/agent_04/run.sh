...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=running\nstarted_utc=%s\n' "$BRANCH" "$AGENT" 'caf375a20530c8bb81e8e8e103a8598c25c11bb0' 'cb4d25ddf1911f588dce6e4c285c9ed74b58b61a' 'gpt-5.5' 'xhigh' 6 "$STARTED" > "$META"
set +e
...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=%s\nstarted_utc=%s\nended_utc=%s\nexit_code=%s\n' "$BRANCH" "$AGENT" 'caf375a20530c8bb81e8e8e103a8598c25c11bb0' 'cb4d25ddf1911f588dce6e4c285c9ed74b58b61a' 'gpt-5.5' 'xhigh' 6 "$final_status" "$STARTED" "$ENDED" "$rc" > "$META"
exit "$rc"
