...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=running\nstarted_utc=%s\n' "$BRANCH" "$AGENT" '20b3ebae90ba6b39c335a1dbdec89affc90c386e' 'a724980b8339f3d9cb3cb857c903db0ece9d417f' 'gpt-5.5' 'xhigh' 3 "$STARTED" > "$META"
set +e
...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=%s\nstarted_utc=%s\nended_utc=%s\nexit_code=%s\n' "$BRANCH" "$AGENT" '20b3ebae90ba6b39c335a1dbdec89affc90c386e' 'a724980b8339f3d9cb3cb857c903db0ece9d417f' 'gpt-5.5' 'xhigh' 3 "$final_status" "$STARTED" "$ENDED" "$rc" > "$META"
exit "$rc"
