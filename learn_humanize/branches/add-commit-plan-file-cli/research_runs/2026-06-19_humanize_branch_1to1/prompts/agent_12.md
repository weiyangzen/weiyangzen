...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-012 | file | `commands/cancel-rlcr-loop.md` | 1341 | command workflow definition for plan/RLCR algorithms |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-042 | file | `prompt-template/block/incomplete-todos.md` | 442 | prompt/block template defining algorithmic transitions, gates, or review contracts |
