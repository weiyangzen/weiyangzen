...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-003 | directory | `hooks` | 77255 | directory contains included core algorithm descendant(s) |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-033 | file | `hooks/lib/template-loader.sh` | 6402 | hook or validator implementation for the RLCR state machine |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-063 | file | `prompt-template/codex/full-alignment-review.md` | 4180 | prompt/block template defining algorithmic transitions, gates, or review contracts |
