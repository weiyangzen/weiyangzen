...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-030 | file | `tests/test-template-references.sh` | 7095 | executable specification for core algorithm behavior |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-060 | file | `prompt-template/claude/next-round-prompt.md` | 1206 | prompt/block template defining algorithmic transitions, gates, or review contracts |
