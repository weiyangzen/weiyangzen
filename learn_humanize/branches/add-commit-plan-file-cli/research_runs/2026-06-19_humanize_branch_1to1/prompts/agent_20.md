...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-020 | file | `hooks/loop-read-validator.sh` | 4005 | hook or validator implementation for the RLCR state machine |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-050 | file | `prompt-template/block/todos-file-access.md` | 253 | prompt/block template defining algorithmic transitions, gates, or review contracts |
