...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-002 | directory | `commands` | 3751 | directory contains included core algorithm descendant(s) |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-032 | file | `hooks/lib/loop-common.sh` | 7976 | hook or validator implementation for the RLCR state machine |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-062 | file | `prompt-template/claude/push-every-round-note.md` | 101 | prompt/block template defining algorithmic transitions, gates, or review contracts |
