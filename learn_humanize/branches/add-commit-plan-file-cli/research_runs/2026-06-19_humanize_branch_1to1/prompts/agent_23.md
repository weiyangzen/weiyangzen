...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-023 | file | `scripts/portable-timeout.sh` | 2116 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-053 | file | `prompt-template/block/wrong-directory-path.md` | 152 | prompt/block template defining algorithmic transitions, gates, or review contracts |
