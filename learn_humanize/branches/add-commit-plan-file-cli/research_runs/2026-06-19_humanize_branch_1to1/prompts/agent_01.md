...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-001 | directory | `.` | 254954 | directory contains included core algorithm descendant(s) |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-031 | file | `tests/test-templates-comprehensive.sh` | 19990 | executable specification for core algorithm behavior |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-061 | file | `prompt-template/claude/post-alignment-action-items.md` | 390 | prompt/block template defining algorithmic transitions, gates, or review contracts |
