...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-007 | file | `README.md` | 9638 | behavior-defining documentation for workflow/state-machine algorithms |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-037 | file | `prompt-template/block/git-not-clean.md` | 817 | prompt/block template defining algorithmic transitions, gates, or review contracts |
