...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-026 | file | `tests/test-plan-file-hooks.sh` | 23428 | executable specification for core algorithm behavior |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-056 | file | `prompt-template/block/wrong-round-number.md` | 225 | prompt/block template defining algorithmic transitions, gates, or review contracts |
