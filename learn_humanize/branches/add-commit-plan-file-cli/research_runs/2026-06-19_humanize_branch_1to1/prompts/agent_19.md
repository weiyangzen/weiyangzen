...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-019 | file | `hooks/loop-plan-file-validator.sh` | 4812 | hook or validator implementation for the RLCR state machine |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-049 | file | `prompt-template/block/summary-bash-write.md` | 302 | prompt/block template defining algorithmic transitions, gates, or review contracts |
