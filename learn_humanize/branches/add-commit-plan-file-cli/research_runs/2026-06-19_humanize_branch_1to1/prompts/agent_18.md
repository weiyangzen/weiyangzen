...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-018 | file | `hooks/loop-edit-validator.sh` | 4035 | hook or validator implementation for the RLCR state machine |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-048 | file | `prompt-template/block/state-file-modification.md` | 238 | prompt/block template defining algorithmic transitions, gates, or review contracts |
