...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-011 | directory | `prompt-template/codex` | 9125 | directory contains included core algorithm descendant(s) |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-041 | file | `prompt-template/block/goal-tracker-not-initialized.md` | 707 | prompt/block template defining algorithmic transitions, gates, or review contracts |
