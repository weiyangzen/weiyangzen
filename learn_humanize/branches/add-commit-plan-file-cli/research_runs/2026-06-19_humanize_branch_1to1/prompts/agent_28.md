...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-028 | file | `tests/test-state-exit-naming.sh` | 7027 | executable specification for core algorithm behavior |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-058 | file | `prompt-template/claude/goal-tracker-update-request.md` | 573 | prompt/block template defining algorithmic transitions, gates, or review contracts |
