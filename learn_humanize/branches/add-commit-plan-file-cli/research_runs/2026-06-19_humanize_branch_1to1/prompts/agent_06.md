...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-006 | directory | `tests` | 96907 | directory contains included core algorithm descendant(s) |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-036 | file | `prompt-template/block/git-not-clean-untracked.md` | 451 | prompt/block template defining algorithmic transitions, gates, or review contracts |
