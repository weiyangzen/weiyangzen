...
|---|---|---:|---:|---|
| ADD_COMMIT_PLAN_FILE_CLI-HZ-010 | directory | `prompt-template/claude` | 2735 | directory contains included core algorithm descendant(s) |
| ADD_COMMIT_PLAN_FILE_CLI-HZ-040 | file | `prompt-template/block/goal-tracker-modification.md` | 792 | prompt/block template defining algorithmic transitions, gates, or review contracts |
