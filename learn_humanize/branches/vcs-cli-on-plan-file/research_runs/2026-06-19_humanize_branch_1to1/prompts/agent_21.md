...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-021 | file | `hooks/loop-write-validator.sh` | 5349 | hook or validator implementation for the RLCR state machine |
| VCS_CLI_ON_PLAN_FILE-HZ-051 | file | `prompt-template/block/pre-112-state-file.md` | 887 | prompt/block template defining algorithmic transitions, gates, or review contracts |
