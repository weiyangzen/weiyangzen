...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-028 | file | `tests/test-template-references.sh` | 7144 | executable specification for core algorithm behavior |
| VCS_CLI_ON_PLAN_FILE-HZ-058 | file | `prompt-template/block/wrong-directory-path.md` | 152 | prompt/block template defining algorithmic transitions, gates, or review contracts |
