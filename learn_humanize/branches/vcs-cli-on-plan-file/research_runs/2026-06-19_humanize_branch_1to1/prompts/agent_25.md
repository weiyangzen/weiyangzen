...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-025 | file | `tests/test-error-scenarios.sh` | 3652 | executable specification for core algorithm behavior |
| VCS_CLI_ON_PLAN_FILE-HZ-055 | file | `prompt-template/block/todos-file-access.md` | 253 | prompt/block template defining algorithmic transitions, gates, or review contracts |
