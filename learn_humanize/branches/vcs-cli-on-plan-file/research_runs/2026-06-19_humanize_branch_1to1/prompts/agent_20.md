...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-020 | file | `hooks/loop-read-validator.sh` | 4005 | hook or validator implementation for the RLCR state machine |
| VCS_CLI_ON_PLAN_FILE-HZ-050 | file | `prompt-template/block/plan-file-uncommitted.md` | 462 | prompt/block template defining algorithmic transitions, gates, or review contracts |
