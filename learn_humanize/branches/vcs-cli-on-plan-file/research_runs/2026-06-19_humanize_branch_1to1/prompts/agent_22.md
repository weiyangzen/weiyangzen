...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-022 | file | `scripts/humanize.sh` | 22548 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| VCS_CLI_ON_PLAN_FILE-HZ-052 | file | `prompt-template/block/prompt-file-write.md` | 413 | prompt/block template defining algorithmic transitions, gates, or review contracts |
