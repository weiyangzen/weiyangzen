You are worker agent_48 in an execution-cron style branch research run.
...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-048 | file | `prompt-template/block/plan-file-outside-repo-conflict.md` | 514 | prompt/block template defining algorithmic transitions, gates, or review contracts |
