...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-019 | file | `hooks/loop-plan-validator.sh` | 11017 | hook or validator implementation for the RLCR state machine |
| VCS_CLI_ON_PLAN_FILE-HZ-049 | file | `prompt-template/block/plan-file-staged.md` | 967 | prompt/block template defining algorithmic transitions, gates, or review contracts |
