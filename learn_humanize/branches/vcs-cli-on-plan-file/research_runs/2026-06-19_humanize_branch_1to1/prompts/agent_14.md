...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-014 | file | `hooks/check-todos-from-transcript.py` | 4425 | hook or validator implementation for the RLCR state machine |
| VCS_CLI_ON_PLAN_FILE-HZ-044 | file | `prompt-template/block/plan-file-changed-prompt-block.md` | 540 | prompt/block template defining algorithmic transitions, gates, or review contracts |
