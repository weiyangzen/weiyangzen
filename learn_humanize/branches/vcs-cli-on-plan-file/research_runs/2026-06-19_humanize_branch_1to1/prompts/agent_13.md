...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-013 | file | `commands/start-rlcr-loop.md` | 2407 | command workflow definition for plan/RLCR algorithms |
| VCS_CLI_ON_PLAN_FILE-HZ-043 | file | `prompt-template/block/plan-file-changed-commit-mode.md` | 599 | prompt/block template defining algorithmic transitions, gates, or review contracts |
