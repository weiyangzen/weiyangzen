...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-027 | file | `tests/test-template-loader.sh` | 18077 | executable specification for core algorithm behavior |
| VCS_CLI_ON_PLAN_FILE-HZ-057 | file | `prompt-template/block/work-summary-missing.md` | 335 | prompt/block template defining algorithmic transitions, gates, or review contracts |
