...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-015 | file | `hooks/hooks.json` | 1397 | hook or validator implementation for the RLCR state machine |
| VCS_CLI_ON_PLAN_FILE-HZ-045 | file | `prompt-template/block/plan-file-committed.md` | 1242 | prompt/block template defining algorithmic transitions, gates, or review contracts |
