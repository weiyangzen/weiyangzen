...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-024 | file | `scripts/setup-rlcr-loop.sh` | 19204 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| VCS_CLI_ON_PLAN_FILE-HZ-054 | file | `prompt-template/block/summary-bash-write.md` | 302 | prompt/block template defining algorithmic transitions, gates, or review contracts |
