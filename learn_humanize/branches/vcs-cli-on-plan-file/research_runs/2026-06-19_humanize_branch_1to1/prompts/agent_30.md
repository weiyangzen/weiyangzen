...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-030 | file | `hooks/lib/loop-common.sh` | 12414 | hook or validator implementation for the RLCR state machine |
| VCS_CLI_ON_PLAN_FILE-HZ-060 | file | `prompt-template/block/wrong-round-file.md` | 343 | prompt/block template defining algorithmic transitions, gates, or review contracts |
