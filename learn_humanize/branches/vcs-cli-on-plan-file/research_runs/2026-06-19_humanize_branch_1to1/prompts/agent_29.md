...
|---|---|---:|---:|---|
| VCS_CLI_ON_PLAN_FILE-HZ-029 | file | `tests/test-templates-comprehensive.sh` | 19990 | executable specification for core algorithm behavior |
| VCS_CLI_ON_PLAN_FILE-HZ-059 | file | `prompt-template/block/wrong-file-location.md` | 318 | prompt/block template defining algorithmic transitions, gates, or review contracts |
