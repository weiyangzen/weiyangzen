...
- [x] IMPL_DCCB_LOOP-HZ-001 `directory` `.`
...
- [x] IMPL_DCCB_LOOP-HZ-002 `directory` `commands`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-003 `directory` `hooks`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-004 `directory` `scripts`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-005 `file` `README.md`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-006 `directory` `hooks/lib`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-007 `file` `commands/cancel-dccb-loop.md`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-008 `file` `commands/cancel-rlcr-loop.md`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-009 `file` `commands/start-dccb-loop.md`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-010 `file` `commands/start-rlcr-loop.md`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-011 `file` `hooks/check-todos-from-transcript.py`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-012 `file` `hooks/hooks.json`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-013 `file` `hooks/loop-bash-validator.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-014 `file` `hooks/loop-codex-stop-hook.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-015 `file` `hooks/loop-dccb-stop-hook.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-016 `file` `hooks/loop-edit-validator.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-017 `file` `hooks/loop-read-validator.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-018 `file` `hooks/loop-write-validator.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-019 `file` `scripts/humanize.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-020 `file` `scripts/portable-timeout.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-021 `file` `scripts/setup-dccb-loop.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-022 `file` `scripts/setup-rlcr-loop.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] IMPL_DCCB_LOOP-HZ-023 `file` `hooks/lib/loop-common.sh`
