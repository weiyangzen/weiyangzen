...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-009 | file | `README.md` | 4026 | behavior-defining documentation for workflow/state-machine algorithms |
| ADD_GEN_PLAN_COMMAND-HZ-039 | file | `tests/test-error-scenarios.sh` | 7691 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-069 | file | `prompt-template/block/large-files.md` | 1088 | prompt/block template defining algorithmic transitions, gates, or review contracts |
