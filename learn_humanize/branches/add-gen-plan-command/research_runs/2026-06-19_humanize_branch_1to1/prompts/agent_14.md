...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-014 | directory | `skills/cancel-rlcr-loop` | 3196 | directory contains included core algorithm descendant(s) |
| ADD_GEN_PLAN_COMMAND-HZ-044 | file | `tests/test-monitor-runtime.sh` | 8952 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-074 | file | `prompt-template/block/state-file-modification.md` | 238 | prompt/block template defining algorithmic transitions, gates, or review contracts |
