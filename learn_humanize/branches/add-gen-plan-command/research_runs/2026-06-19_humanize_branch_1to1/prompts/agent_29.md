...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-029 | file | `scripts/humanize.sh` | 35827 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| ADD_GEN_PLAN_COMMAND-HZ-059 | file | `prompt-template/block/git-add-humanize.md` | 763 | prompt/block template defining algorithmic transitions, gates, or review contracts |
| ADD_GEN_PLAN_COMMAND-HZ-089 | file | `prompt-template/claude/push-every-round-note.md` | 101 | prompt/block template defining algorithmic transitions, gates, or review contracts |
