...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-011 | directory | `prompt-template/block` | 11039 | directory contains included core algorithm descendant(s) |
| ADD_GEN_PLAN_COMMAND-HZ-041 | file | `tests/test-hook-preservation.sh` | 20567 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-071 | file | `prompt-template/block/plan-file-modified.md` | 383 | prompt/block template defining algorithmic transitions, gates, or review contracts |
