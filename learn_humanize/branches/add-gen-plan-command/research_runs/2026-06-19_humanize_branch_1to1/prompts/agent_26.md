...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-026 | file | `hooks/loop-plan-file-validator.sh` | 7830 | hook or validator implementation for the RLCR state machine |
| ADD_GEN_PLAN_COMMAND-HZ-056 | file | `hooks/lib/template-loader.sh` | 7114 | hook or validator implementation for the RLCR state machine |
| ADD_GEN_PLAN_COMMAND-HZ-086 | file | `prompt-template/claude/next-round-footer.md` | 465 | prompt/block template defining algorithmic transitions, gates, or review contracts |
