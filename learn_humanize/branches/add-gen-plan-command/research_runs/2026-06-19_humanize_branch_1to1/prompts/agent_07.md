...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-007 | directory | `skills` | 14218 | directory contains included core algorithm descendant(s) |
| ADD_GEN_PLAN_COMMAND-HZ-037 | file | `tests/test-bash-validator-patterns.sh` | 6658 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-067 | file | `prompt-template/block/goal-tracker-not-initialized.md` | 707 | prompt/block template defining algorithmic transitions, gates, or review contracts |
