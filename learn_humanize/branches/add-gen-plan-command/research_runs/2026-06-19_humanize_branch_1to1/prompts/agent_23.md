...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-023 | file | `hooks/loop-bash-validator.sh` | 13540 | hook or validator implementation for the RLCR state machine |
| ADD_GEN_PLAN_COMMAND-HZ-053 | file | `tests/test-todo-checker.sh` | 10313 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-083 | file | `prompt-template/block/wrong-summary-location.md` | 109 | prompt/block template defining algorithmic transitions, gates, or review contracts |
