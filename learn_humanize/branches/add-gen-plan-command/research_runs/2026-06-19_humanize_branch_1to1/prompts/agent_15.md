...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-015 | directory | `skills/gen-plan` | 8585 | directory contains included core algorithm descendant(s) |
| ADD_GEN_PLAN_COMMAND-HZ-045 | file | `tests/test-plan-file-hooks.sh` | 34778 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-075 | file | `prompt-template/block/summary-bash-write.md` | 302 | prompt/block template defining algorithmic transitions, gates, or review contracts |
