...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-006 | directory | `scripts` | 66304 | directory contains included core algorithm descendant(s) |
| ADD_GEN_PLAN_COMMAND-HZ-036 | file | `tests/test-ansi-parsing.sh` | 5801 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-066 | file | `prompt-template/block/goal-tracker-modification.md` | 792 | prompt/block template defining algorithmic transitions, gates, or review contracts |
