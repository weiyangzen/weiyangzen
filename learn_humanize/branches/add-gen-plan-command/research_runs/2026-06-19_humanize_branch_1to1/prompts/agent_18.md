...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-018 | file | `commands/cancel-rlcr-loop.md` | 398 | command workflow definition for plan/RLCR algorithms |
| ADD_GEN_PLAN_COMMAND-HZ-048 | file | `tests/test-skill-structure.sh` | 27100 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-078 | file | `prompt-template/block/work-summary-missing.md` | 335 | prompt/block template defining algorithmic transitions, gates, or review contracts |
