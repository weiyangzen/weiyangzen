...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-019 | file | `commands/gen-plan.md` | 532 | command workflow definition for plan/RLCR algorithms |
| ADD_GEN_PLAN_COMMAND-HZ-049 | file | `tests/test-state-exit-naming.sh` | 8959 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-079 | file | `prompt-template/block/wrong-directory-path.md` | 152 | prompt/block template defining algorithmic transitions, gates, or review contracts |
