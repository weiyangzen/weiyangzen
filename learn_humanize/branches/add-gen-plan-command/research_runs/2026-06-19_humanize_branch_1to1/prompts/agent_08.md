...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-008 | directory | `tests` | 335719 | directory contains included core algorithm descendant(s) |
| ADD_GEN_PLAN_COMMAND-HZ-038 | file | `tests/test-cancel-signal-file.sh` | 41224 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-068 | file | `prompt-template/block/incomplete-todos.md` | 442 | prompt/block template defining algorithmic transitions, gates, or review contracts |
