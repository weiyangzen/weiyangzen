...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-013 | directory | `prompt-template/codex` | 9101 | directory contains included core algorithm descendant(s) |
| ADD_GEN_PLAN_COMMAND-HZ-043 | file | `tests/test-monitor-e2e-real.sh` | 11060 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-073 | file | `prompt-template/block/schema-outdated.md` | 394 | prompt/block template defining algorithmic transitions, gates, or review contracts |
