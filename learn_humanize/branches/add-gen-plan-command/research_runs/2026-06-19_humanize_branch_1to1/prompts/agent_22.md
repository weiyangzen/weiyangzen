...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-022 | file | `hooks/hooks.json` | 1402 | hook or validator implementation for the RLCR state machine |
| ADD_GEN_PLAN_COMMAND-HZ-052 | file | `tests/test-templates-comprehensive.sh` | 19978 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-082 | file | `prompt-template/block/wrong-round-number.md` | 225 | prompt/block template defining algorithmic transitions, gates, or review contracts |
