...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-017 | file | `agents/draft-relevance-checker.md` | 1788 | agent prompt/policy file defining review or planning behavior |
| ADD_GEN_PLAN_COMMAND-HZ-047 | file | `tests/test-skill-invocation.sh` | 14555 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-077 | file | `prompt-template/block/unpushed-commits.md` | 348 | prompt/block template defining algorithmic transitions, gates, or review contracts |
