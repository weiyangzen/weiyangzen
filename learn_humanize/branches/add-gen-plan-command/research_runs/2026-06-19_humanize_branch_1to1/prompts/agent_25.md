...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-025 | file | `hooks/loop-edit-validator.sh` | 4887 | hook or validator implementation for the RLCR state machine |
| ADD_GEN_PLAN_COMMAND-HZ-055 | file | `hooks/lib/loop-common.sh` | 24217 | hook or validator implementation for the RLCR state machine |
| ADD_GEN_PLAN_COMMAND-HZ-085 | file | `prompt-template/claude/goal-tracker-update-request.md` | 573 | prompt/block template defining algorithmic transitions, gates, or review contracts |
