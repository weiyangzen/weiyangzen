...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-016 | directory | `skills/start-rlcr-loop` | 2437 | directory contains included core algorithm descendant(s) |
| ADD_GEN_PLAN_COMMAND-HZ-046 | file | `tests/test-plan-file-validation.sh` | 22731 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-076 | file | `prompt-template/block/todos-file-access.md` | 253 | prompt/block template defining algorithmic transitions, gates, or review contracts |
