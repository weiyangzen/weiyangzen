...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-012 | directory | `prompt-template/claude` | 4385 | directory contains included core algorithm descendant(s) |
| ADD_GEN_PLAN_COMMAND-HZ-042 | file | `tests/test-humanize-escape.sh` | 12115 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-072 | file | `prompt-template/block/prompt-file-write.md` | 413 | prompt/block template defining algorithmic transitions, gates, or review contracts |
