...
|---|---|---:|---:|---|
| ADD_GEN_PLAN_COMMAND-HZ-010 | directory | `hooks/lib` | 31331 | directory contains included core algorithm descendant(s) |
| ADD_GEN_PLAN_COMMAND-HZ-040 | file | `tests/test-finalize-phase.sh` | 23200 | executable specification for core algorithm behavior |
| ADD_GEN_PLAN_COMMAND-HZ-070 | file | `prompt-template/block/plan-backup-protected.md` | 259 | prompt/block template defining algorithmic transitions, gates, or review contracts |
