...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-001 | directory | `.` | 258471 | directory contains included core algorithm descendant(s) |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-031 | file | `tests/test-templates-comprehensive.sh` | 19978 | executable specification for core algorithm behavior |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-061 | file | `prompt-template/claude/post-alignment-action-items.md` | 390 | prompt/block template defining algorithmic transitions, gates, or review contracts |
