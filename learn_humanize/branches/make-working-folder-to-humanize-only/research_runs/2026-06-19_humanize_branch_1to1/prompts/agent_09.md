...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-009 | directory | `prompt-template/block` | 9606 | directory contains included core algorithm descendant(s) |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-039 | file | `prompt-template/block/goal-tracker-bash-write.md` | 289 | prompt/block template defining algorithmic transitions, gates, or review contracts |
