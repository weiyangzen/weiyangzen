...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-028 | file | `tests/test-state-exit-naming.sh` | 8935 | executable specification for core algorithm behavior |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-058 | file | `prompt-template/claude/goal-tracker-update-request.md` | 573 | prompt/block template defining algorithmic transitions, gates, or review contracts |
