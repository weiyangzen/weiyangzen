...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-015 | file | `hooks/hooks.json` | 1402 | hook or validator implementation for the RLCR state machine |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-045 | file | `prompt-template/block/plan-file-modified.md` | 383 | prompt/block template defining algorithmic transitions, gates, or review contracts |
