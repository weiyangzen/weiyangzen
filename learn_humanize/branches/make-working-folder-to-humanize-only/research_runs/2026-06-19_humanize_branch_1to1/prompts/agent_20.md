...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-020 | file | `hooks/loop-read-validator.sh` | 3993 | hook or validator implementation for the RLCR state machine |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-050 | file | `prompt-template/block/todos-file-access.md` | 253 | prompt/block template defining algorithmic transitions, gates, or review contracts |
