...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-012 | file | `commands/cancel-rlcr-loop.md` | 1311 | command workflow definition for plan/RLCR algorithms |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-042 | file | `prompt-template/block/incomplete-todos.md` | 442 | prompt/block template defining algorithmic transitions, gates, or review contracts |
