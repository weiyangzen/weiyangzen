...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-007 | file | `README.md` | 9596 | behavior-defining documentation for workflow/state-machine algorithms |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-037 | file | `prompt-template/block/git-not-clean.md` | 817 | prompt/block template defining algorithmic transitions, gates, or review contracts |
