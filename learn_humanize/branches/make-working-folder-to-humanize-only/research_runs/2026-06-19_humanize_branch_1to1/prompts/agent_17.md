...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-017 | file | `hooks/loop-codex-stop-hook.sh` | 33709 | hook or validator implementation for the RLCR state machine |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-047 | file | `prompt-template/block/schema-outdated.md` | 394 | prompt/block template defining algorithmic transitions, gates, or review contracts |
