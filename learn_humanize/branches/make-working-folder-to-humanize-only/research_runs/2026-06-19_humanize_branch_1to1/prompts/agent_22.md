...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-022 | file | `scripts/humanize.sh` | 22518 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-052 | file | `prompt-template/block/work-summary-missing.md` | 335 | prompt/block template defining algorithmic transitions, gates, or review contracts |
