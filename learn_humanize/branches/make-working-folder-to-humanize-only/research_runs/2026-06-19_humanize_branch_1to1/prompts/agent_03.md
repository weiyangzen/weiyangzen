...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-003 | directory | `hooks` | 77140 | directory contains included core algorithm descendant(s) |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-033 | file | `hooks/lib/template-loader.sh` | 6402 | hook or validator implementation for the RLCR state machine |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-063 | file | `prompt-template/codex/full-alignment-review.md` | 4156 | prompt/block template defining algorithmic transitions, gates, or review contracts |
