...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-014 | file | `hooks/check-todos-from-transcript.py` | 4425 | hook or validator implementation for the RLCR state machine |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-044 | file | `prompt-template/block/plan-backup-protected.md` | 259 | prompt/block template defining algorithmic transitions, gates, or review contracts |
