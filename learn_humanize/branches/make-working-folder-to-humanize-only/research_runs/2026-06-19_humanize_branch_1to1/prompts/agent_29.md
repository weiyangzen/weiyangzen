...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-029 | file | `tests/test-template-loader.sh` | 18077 | executable specification for core algorithm behavior |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-059 | file | `prompt-template/claude/next-round-footer.md` | 465 | prompt/block template defining algorithmic transitions, gates, or review contracts |
