...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-026 | file | `tests/test-plan-file-hooks.sh` | 25332 | executable specification for core algorithm behavior |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-056 | file | `prompt-template/block/wrong-round-number.md` | 225 | prompt/block template defining algorithmic transitions, gates, or review contracts |
