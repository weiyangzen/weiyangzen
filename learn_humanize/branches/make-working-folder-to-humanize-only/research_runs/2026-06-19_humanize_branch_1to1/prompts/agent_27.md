...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-027 | file | `tests/test-plan-file-validation.sh` | 17638 | executable specification for core algorithm behavior |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-057 | file | `prompt-template/block/wrong-summary-location.md` | 109 | prompt/block template defining algorithmic transitions, gates, or review contracts |
