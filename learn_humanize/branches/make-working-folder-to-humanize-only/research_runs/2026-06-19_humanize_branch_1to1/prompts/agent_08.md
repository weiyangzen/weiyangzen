...
|---|---|---:|---:|---|
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-008 | directory | `hooks/lib` | 14365 | directory contains included core algorithm descendant(s) |
| MAKE_WORKING_FOLDER_TO_HUMANIZE_ONLY-HZ-038 | file | `prompt-template/block/git-push.md` | 270 | prompt/block template defining algorithmic transitions, gates, or review contracts |
