...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=running\nstarted_utc=%s\n' "$BRANCH" "$AGENT" '0c107abc65600bca4e18b04265b48c91da772491' 'f3c9561d9e816fb24001ba1b460b3929fec0423e' 'gpt-5.5' 'xhigh' 1 "$STARTED" > "$META"
set +e
...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=%s\nstarted_utc=%s\nended_utc=%s\nexit_code=%s\n' "$BRANCH" "$AGENT" '0c107abc65600bca4e18b04265b48c91da772491' 'f3c9561d9e816fb24001ba1b460b3929fec0423e' 'gpt-5.5' 'xhigh' 1 "$final_status" "$STARTED" "$ENDED" "$rc" > "$META"
exit "$rc"
