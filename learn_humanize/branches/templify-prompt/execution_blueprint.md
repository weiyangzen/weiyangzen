...
- [x] TEMPLIFY_PROMPT-HZ-001 `directory` `.`
...
- [x] TEMPLIFY_PROMPT-HZ-002 `directory` `commands`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-003 `directory` `hooks`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-004 `directory` `prompt-template`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-005 `directory` `scripts`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-006 `directory` `tests`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-007 `file` `README.md`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-008 `directory` `hooks/lib`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-009 `directory` `prompt-template/block`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-010 `directory` `prompt-template/claude`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-011 `directory` `prompt-template/codex`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-012 `file` `commands/cancel-rlcr-loop.md`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-013 `file` `commands/start-rlcr-loop.md`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-014 `file` `hooks/check-todos-from-transcript.py`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-015 `file` `hooks/hooks.json`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-016 `file` `hooks/loop-bash-validator.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-017 `file` `hooks/loop-codex-stop-hook.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-018 `file` `hooks/loop-edit-validator.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-019 `file` `hooks/loop-read-validator.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-020 `file` `hooks/loop-write-validator.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-021 `file` `scripts/humanize.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-022 `file` `scripts/portable-timeout.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-023 `file` `scripts/setup-rlcr-loop.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-024 `file` `tests/test-error-scenarios.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-025 `file` `tests/test-template-loader.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-026 `file` `tests/test-template-references.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-027 `file` `tests/test-templates-comprehensive.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-028 `file` `hooks/lib/loop-common.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-029 `file` `hooks/lib/template-loader.sh`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-030 `file` `prompt-template/block/codex-review-failed.md`
  ...
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-031 `file` `prompt-template/block/git-not-clean-humanize-local.md`
  - assigned_agent: `agent_01`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_01/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-032 `file` `prompt-template/block/git-not-clean-untracked.md`
  - assigned_agent: `agent_02`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_02/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-033 `file` `prompt-template/block/git-not-clean.md`
  - assigned_agent: `agent_03`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_03/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-034 `file` `prompt-template/block/git-push.md`
  - assigned_agent: `agent_04`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_04/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-035 `file` `prompt-template/block/goal-tracker-bash-write.md`
  - assigned_agent: `agent_05`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_05/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-036 `file` `prompt-template/block/goal-tracker-modification.md`
  - assigned_agent: `agent_06`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_06/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-037 `file` `prompt-template/block/goal-tracker-not-initialized.md`
  - assigned_agent: `agent_07`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_07/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-038 `file` `prompt-template/block/incomplete-todos.md`
  - assigned_agent: `agent_08`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_08/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-039 `file` `prompt-template/block/large-files.md`
  - assigned_agent: `agent_09`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_09/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-040 `file` `prompt-template/block/prompt-file-write.md`
  - assigned_agent: `agent_10`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_10/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-041 `file` `prompt-template/block/state-file-modification.md`
  - assigned_agent: `agent_11`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_11/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-042 `file` `prompt-template/block/summary-bash-write.md`
  - assigned_agent: `agent_12`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_12/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-043 `file` `prompt-template/block/todos-file-access.md`
  - assigned_agent: `agent_13`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_13/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-044 `file` `prompt-template/block/unpushed-commits.md`
  - assigned_agent: `agent_14`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_14/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-045 `file` `prompt-template/block/work-summary-missing.md`
  - assigned_agent: `agent_15`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_15/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-046 `file` `prompt-template/block/wrong-directory-path.md`
  - assigned_agent: `agent_16`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_16/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-047 `file` `prompt-template/block/wrong-file-location.md`
  - assigned_agent: `agent_17`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_17/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-048 `file` `prompt-template/block/wrong-round-file.md`
  - assigned_agent: `agent_18`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_18/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-049 `file` `prompt-template/block/wrong-round-number.md`
  - assigned_agent: `agent_19`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_19/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-050 `file` `prompt-template/block/wrong-summary-location.md`
  - assigned_agent: `agent_20`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_20/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-051 `file` `prompt-template/claude/goal-tracker-update-request.md`
  - assigned_agent: `agent_21`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_21/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-052 `file` `prompt-template/claude/next-round-footer.md`
  - assigned_agent: `agent_22`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_22/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-053 `file` `prompt-template/claude/next-round-prompt.md`
  - assigned_agent: `agent_23`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_23/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-054 `file` `prompt-template/claude/post-alignment-action-items.md`
  - assigned_agent: `agent_24`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_24/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-055 `file` `prompt-template/claude/push-every-round-note.md`
  - assigned_agent: `agent_25`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_25/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-056 `file` `prompt-template/codex/full-alignment-review.md`
  - assigned_agent: `agent_26`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_26/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-057 `file` `prompt-template/codex/goal-tracker-update-section.md`
  - assigned_agent: `agent_27`
  ...
  - worker_evidence: `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_27/output.md`
  - master_status: accepted after complete status, output existence, and item-id coverage verification
- [x] TEMPLIFY_PROMPT-HZ-058 `file` `prompt-template/codex/regular-review.md`
  - assigned_agent: `agent_28`
