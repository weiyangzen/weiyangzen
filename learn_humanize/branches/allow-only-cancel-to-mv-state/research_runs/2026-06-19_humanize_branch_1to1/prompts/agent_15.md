...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-015 | file | `hooks/hooks.json` | 1402 | hook or validator implementation for the RLCR state machine |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-045 | file | `prompt-template/block/git-status-failed.md` | 326 | prompt/block template defining algorithmic transitions, gates, or review contracts |
