...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-021 | file | `hooks/loop-write-validator.sh` | 6368 | hook or validator implementation for the RLCR state machine |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-051 | file | `prompt-template/block/plan-backup-protected.md` | 259 | prompt/block template defining algorithmic transitions, gates, or review contracts |
