...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-019 | file | `hooks/loop-plan-file-validator.sh` | 7671 | hook or validator implementation for the RLCR state machine |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-049 | file | `prompt-template/block/incomplete-todos.md` | 442 | prompt/block template defining algorithmic transitions, gates, or review contracts |
