...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-022 | file | `scripts/humanize.sh` | 29644 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-052 | file | `prompt-template/block/plan-file-modified.md` | 383 | prompt/block template defining algorithmic transitions, gates, or review contracts |
