...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-003 | directory | `hooks` | 101883 | directory contains included core algorithm descendant(s) |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-033 | file | `tests/test-state-exit-naming.sh` | 8959 | executable specification for core algorithm behavior |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-063 | file | `prompt-template/block/wrong-round-number.md` | 225 | prompt/block template defining algorithmic transitions, gates, or review contracts |
