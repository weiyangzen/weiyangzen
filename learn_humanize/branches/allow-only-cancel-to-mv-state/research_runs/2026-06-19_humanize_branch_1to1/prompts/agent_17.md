...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-017 | file | `hooks/loop-codex-stop-hook.sh` | 37108 | hook or validator implementation for the RLCR state machine |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-047 | file | `prompt-template/block/goal-tracker-modification.md` | 792 | prompt/block template defining algorithmic transitions, gates, or review contracts |
