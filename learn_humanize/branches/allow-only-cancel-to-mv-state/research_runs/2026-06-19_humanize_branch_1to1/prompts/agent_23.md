...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-023 | file | `scripts/portable-timeout.sh` | 2116 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-053 | file | `prompt-template/block/prompt-file-write.md` | 413 | prompt/block template defining algorithmic transitions, gates, or review contracts |
