...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-006 | directory | `tests` | 203834 | directory contains included core algorithm descendant(s) |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-036 | file | `tests/test-templates-comprehensive.sh` | 19978 | executable specification for core algorithm behavior |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-066 | file | `prompt-template/claude/next-round-footer.md` | 465 | prompt/block template defining algorithmic transitions, gates, or review contracts |
