...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-005 | directory | `scripts` | 56399 | directory contains included core algorithm descendant(s) |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-035 | file | `tests/test-template-references.sh` | 7095 | executable specification for core algorithm behavior |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-065 | file | `prompt-template/claude/goal-tracker-update-request.md` | 573 | prompt/block template defining algorithmic transitions, gates, or review contracts |
