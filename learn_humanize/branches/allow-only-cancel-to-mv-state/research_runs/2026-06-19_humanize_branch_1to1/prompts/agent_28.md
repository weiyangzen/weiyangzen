...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-028 | file | `tests/test-bash-validator-patterns.sh` | 6658 | executable specification for core algorithm behavior |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-058 | file | `prompt-template/block/unpushed-commits.md` | 348 | prompt/block template defining algorithmic transitions, gates, or review contracts |
