...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-009 | directory | `prompt-template/block` | 9932 | directory contains included core algorithm descendant(s) |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-039 | file | `hooks/lib/template-loader.sh` | 7114 | hook or validator implementation for the RLCR state machine |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-069 | file | `prompt-template/claude/push-every-round-note.md` | 101 | prompt/block template defining algorithmic transitions, gates, or review contracts |
