...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-007 | file | `README.md` | 9596 | behavior-defining documentation for workflow/state-machine algorithms |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-037 | file | `tests/test-todo-checker.sh` | 10313 | executable specification for core algorithm behavior |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-067 | file | `prompt-template/claude/next-round-prompt.md` | 1206 | prompt/block template defining algorithmic transitions, gates, or review contracts |
