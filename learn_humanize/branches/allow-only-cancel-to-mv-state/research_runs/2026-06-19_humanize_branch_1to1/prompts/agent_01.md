...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-001 | directory | `.` | 397421 | directory contains included core algorithm descendant(s) |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-031 | file | `tests/test-plan-file-hooks.sh` | 34778 | executable specification for core algorithm behavior |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-061 | file | `prompt-template/block/wrong-file-location.md` | 318 | prompt/block template defining algorithmic transitions, gates, or review contracts |
