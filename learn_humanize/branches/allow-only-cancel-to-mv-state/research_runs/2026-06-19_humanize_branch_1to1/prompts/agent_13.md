...
|---|---|---:|---:|---|
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-013 | file | `commands/start-rlcr-loop.md` | 2410 | command workflow definition for plan/RLCR algorithms |
| ALLOW_ONLY_CANCEL_TO_MV_STATE-HZ-043 | file | `prompt-template/block/git-not-clean.md` | 817 | prompt/block template defining algorithmic transitions, gates, or review contracts |
