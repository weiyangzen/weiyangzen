...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=running\nstarted_utc=%s\n' "$BRANCH" "$AGENT" '4a4e59ce0cc5613c54d15754a29c7d2a2e9be058' 'e5a1cc8e7baf55b12efeae3fb5564c88e5173747' 'gpt-5.5' 'xhigh' 4 "$STARTED" > "$META"
set +e
...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=%s\nstarted_utc=%s\nended_utc=%s\nexit_code=%s\n' "$BRANCH" "$AGENT" '4a4e59ce0cc5613c54d15754a29c7d2a2e9be058' 'e5a1cc8e7baf55b12efeae3fb5564c88e5173747' 'gpt-5.5' 'xhigh' 4 "$final_status" "$STARTED" "$ENDED" "$rc" > "$META"
exit "$rc"
