...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=running\nstarted_utc=%s\n' "$BRANCH" "$AGENT" 'cf17140050c4e063f27924c2d56cc2279d81f4cd' 'e82a446dc9fb060a3c0edf5156d4934bee330e53' 'gpt-5.5' 'xhigh' 6 "$STARTED" > "$META"
set +e
...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=%s\nstarted_utc=%s\nended_utc=%s\nexit_code=%s\n' "$BRANCH" "$AGENT" 'cf17140050c4e063f27924c2d56cc2279d81f4cd' 'e82a446dc9fb060a3c0edf5156d4934bee330e53' 'gpt-5.5' 'xhigh' 6 "$final_status" "$STARTED" "$ENDED" "$rc" > "$META"
exit "$rc"
