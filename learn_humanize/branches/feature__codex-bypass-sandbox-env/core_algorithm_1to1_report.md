# Humanize `feature/codex-bypass-sandbox-env` Core Algorithm 1:1 Research Report
...
- Read-only source export: `/Users/wangweiyang/GitHub/humanize_branch_worktrees/feature__codex-bypass-sandbox-env`
- Codex model: `gpt-5.5`
...
|---|---:|---:|---|
| `agent_01` | 5 | 1444070 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_01/output.md` |
...
| `agent_04` | 5 | 306083 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_04/output.md` |
...
| `agent_07` | 5 | 886888 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_07/output.md` |
| `agent_08` | 5 | 45431 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_08/output.md` |
| `agent_09` | 5 | 81008 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_09/output.md` |
| `agent_10` | 5 | 84715 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_10/output.md` |
...
| `agent_17` | 5 | 45011 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_17/output.md` |
...
| `agent_26` | 4 | 77819 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_26/output.md` |
...
| `agent_29` | 4 | 45591 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_29/output.md` |
| `agent_30` | 4 | 34475 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_30/output.md` |
