...
|---|---|---:|---:|---|
| GENERAL_REFACTOR_AND_REVIEW-HZ-022 | file | `scripts/humanize.sh` | 22518 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| GENERAL_REFACTOR_AND_REVIEW-HZ-052 | file | `prompt-template/block/prompt-file-write.md` | 413 | prompt/block template defining algorithmic transitions, gates, or review contracts |
