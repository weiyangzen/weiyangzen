...
|---|---|---:|---:|---|
| GENERAL_REFACTOR_AND_REVIEW-HZ-006 | directory | `tests` | 162577 | directory contains included core algorithm descendant(s) |
| GENERAL_REFACTOR_AND_REVIEW-HZ-036 | file | `tests/test-todo-checker.sh` | 10313 | executable specification for core algorithm behavior |
| GENERAL_REFACTOR_AND_REVIEW-HZ-066 | file | `prompt-template/claude/next-round-prompt.md` | 1206 | prompt/block template defining algorithmic transitions, gates, or review contracts |
