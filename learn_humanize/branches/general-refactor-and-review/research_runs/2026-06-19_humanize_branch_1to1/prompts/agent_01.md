...
|---|---|---:|---:|---|
| GENERAL_REFACTOR_AND_REVIEW-HZ-001 | directory | `.` | 337180 | directory contains included core algorithm descendant(s) |
| GENERAL_REFACTOR_AND_REVIEW-HZ-031 | file | `tests/test-plan-file-validation.sh` | 22731 | executable specification for core algorithm behavior |
| GENERAL_REFACTOR_AND_REVIEW-HZ-061 | file | `prompt-template/block/wrong-round-file.md` | 343 | prompt/block template defining algorithmic transitions, gates, or review contracts |
