...
|---|---|---:|---:|---|
| GENERAL_REFACTOR_AND_REVIEW-HZ-011 | directory | `prompt-template/codex` | 9101 | directory contains included core algorithm descendant(s) |
| GENERAL_REFACTOR_AND_REVIEW-HZ-041 | file | `prompt-template/block/git-not-clean-untracked.md` | 451 | prompt/block template defining algorithmic transitions, gates, or review contracts |
| GENERAL_REFACTOR_AND_REVIEW-HZ-071 | file | `prompt-template/codex/regular-review.md` | 3898 | prompt/block template defining algorithmic transitions, gates, or review contracts |
