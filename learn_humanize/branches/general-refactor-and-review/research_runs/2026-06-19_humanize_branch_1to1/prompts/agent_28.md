...
|---|---|---:|---:|---|
| GENERAL_REFACTOR_AND_REVIEW-HZ-028 | file | `tests/test-bash-validator-patterns.sh` | 6658 | executable specification for core algorithm behavior |
| GENERAL_REFACTOR_AND_REVIEW-HZ-058 | file | `prompt-template/block/work-summary-missing.md` | 335 | prompt/block template defining algorithmic transitions, gates, or review contracts |
