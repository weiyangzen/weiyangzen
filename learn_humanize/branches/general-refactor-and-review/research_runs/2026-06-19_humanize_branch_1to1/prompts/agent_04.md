...
|---|---|---:|---:|---|
| GENERAL_REFACTOR_AND_REVIEW-HZ-004 | directory | `prompt-template` | 21768 | directory contains included core algorithm descendant(s) |
| GENERAL_REFACTOR_AND_REVIEW-HZ-034 | file | `tests/test-template-references.sh` | 7095 | executable specification for core algorithm behavior |
| GENERAL_REFACTOR_AND_REVIEW-HZ-064 | file | `prompt-template/claude/goal-tracker-update-request.md` | 573 | prompt/block template defining algorithmic transitions, gates, or review contracts |
