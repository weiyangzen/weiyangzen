...
|---|---|---:|---:|---|
| GENERAL_REFACTOR_AND_REVIEW-HZ-007 | file | `README.md` | 9596 | behavior-defining documentation for workflow/state-machine algorithms |
| GENERAL_REFACTOR_AND_REVIEW-HZ-037 | file | `hooks/lib/loop-common.sh` | 12311 | hook or validator implementation for the RLCR state machine |
| GENERAL_REFACTOR_AND_REVIEW-HZ-067 | file | `prompt-template/claude/post-alignment-action-items.md` | 390 | prompt/block template defining algorithmic transitions, gates, or review contracts |
