...
|---|---|---:|---:|---|
| GENERAL_REFACTOR_AND_REVIEW-HZ-020 | file | `hooks/loop-read-validator.sh` | 4407 | hook or validator implementation for the RLCR state machine |
| GENERAL_REFACTOR_AND_REVIEW-HZ-050 | file | `prompt-template/block/plan-backup-protected.md` | 259 | prompt/block template defining algorithmic transitions, gates, or review contracts |
