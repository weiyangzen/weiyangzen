...
|---|---|---:|---:|---|
| GENERAL_REFACTOR_AND_REVIEW-HZ-018 | file | `hooks/loop-edit-validator.sh` | 4417 | hook or validator implementation for the RLCR state machine |
| GENERAL_REFACTOR_AND_REVIEW-HZ-048 | file | `prompt-template/block/incomplete-todos.md` | 442 | prompt/block template defining algorithmic transitions, gates, or review contracts |
