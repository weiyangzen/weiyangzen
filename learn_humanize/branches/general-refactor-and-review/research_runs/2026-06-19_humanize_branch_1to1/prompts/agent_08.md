...
|---|---|---:|---:|---|
| GENERAL_REFACTOR_AND_REVIEW-HZ-008 | directory | `hooks/lib` | 19425 | directory contains included core algorithm descendant(s) |
| GENERAL_REFACTOR_AND_REVIEW-HZ-038 | file | `hooks/lib/template-loader.sh` | 7114 | hook or validator implementation for the RLCR state machine |
| GENERAL_REFACTOR_AND_REVIEW-HZ-068 | file | `prompt-template/claude/push-every-round-note.md` | 101 | prompt/block template defining algorithmic transitions, gates, or review contracts |
