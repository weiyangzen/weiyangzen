...
|---|---|---:|---:|---|
| GENERAL_REFACTOR_AND_REVIEW-HZ-023 | file | `scripts/portable-timeout.sh` | 2116 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| GENERAL_REFACTOR_AND_REVIEW-HZ-053 | file | `prompt-template/block/schema-outdated.md` | 394 | prompt/block template defining algorithmic transitions, gates, or review contracts |
