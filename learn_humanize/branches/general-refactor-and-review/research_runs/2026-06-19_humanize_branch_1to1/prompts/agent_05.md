...
|---|---|---:|---:|---|
| GENERAL_REFACTOR_AND_REVIEW-HZ-005 | directory | `scripts` | 49273 | directory contains included core algorithm descendant(s) |
| GENERAL_REFACTOR_AND_REVIEW-HZ-035 | file | `tests/test-templates-comprehensive.sh` | 19978 | executable specification for core algorithm behavior |
| GENERAL_REFACTOR_AND_REVIEW-HZ-065 | file | `prompt-template/claude/next-round-footer.md` | 465 | prompt/block template defining algorithmic transitions, gates, or review contracts |
