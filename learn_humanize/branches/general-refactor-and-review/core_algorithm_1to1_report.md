# Humanize `general-refactor-and-review` Core Algorithm 1:1 Research Report
...
- Read-only source export: `/Users/wangweiyang/GitHub/humanize_branch_worktrees/general-refactor-and-review`
- Codex model: `gpt-5.5`
...
|---|---:|---:|---|
| `agent_01` | 3 | 360254 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_01/output.md` |
...
| `agent_05` | 3 | 69716 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_05/output.md` |
...
| `agent_22` | 2 | 22931 | `research_runs/2026-06-19_humanize_branch_1to1/agents/agent_22/output.md` |
