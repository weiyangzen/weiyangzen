...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=running\nstarted_utc=%s\n' "$BRANCH" "$AGENT" '2da7defbd5e955dbc329a27f1745fa74a0bee3f7' 'bef2487769543ff367da2da425136b0cfefae129' 'gpt-5.5' 'xhigh' 9 "$STARTED" > "$META"
set +e
...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=%s\nstarted_utc=%s\nended_utc=%s\nexit_code=%s\n' "$BRANCH" "$AGENT" '2da7defbd5e955dbc329a27f1745fa74a0bee3f7' 'bef2487769543ff367da2da425136b0cfefae129' 'gpt-5.5' 'xhigh' 9 "$final_status" "$STARTED" "$ENDED" "$rc" > "$META"
exit "$rc"
