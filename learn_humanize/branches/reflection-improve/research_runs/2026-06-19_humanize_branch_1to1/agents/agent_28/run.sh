...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=running\nstarted_utc=%s\n' "$BRANCH" "$AGENT" '13a47fb2260667a272b448e8d3c1a521f2382590' '205613f9f58731a061e3e9aa4e46a09e2482de2b' 'gpt-5.5' 'xhigh' 6 "$STARTED" > "$META"
set +e
...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=%s\nstarted_utc=%s\nended_utc=%s\nexit_code=%s\n' "$BRANCH" "$AGENT" '13a47fb2260667a272b448e8d3c1a521f2382590' '205613f9f58731a061e3e9aa4e46a09e2482de2b' 'gpt-5.5' 'xhigh' 6 "$final_status" "$STARTED" "$ENDED" "$rc" > "$META"
exit "$rc"
