...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-030 | file | `tests/test-cancel-signal-file.sh` | 41224 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-060 | file | `prompt-template/block/plan-file-modified.md` | 383 | prompt/block template defining algorithmic transitions, gates, or review contracts |
