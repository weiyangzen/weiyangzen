...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-019 | file | `hooks/loop-plan-file-validator.sh` | 7830 | hook or validator implementation for the RLCR state machine |
| FIX_HUMANIZE_ESCAPE-HZ-049 | file | `prompt-template/block/git-not-clean-humanize-local.md` | 237 | prompt/block template defining algorithmic transitions, gates, or review contracts |
| FIX_HUMANIZE_ESCAPE-HZ-079 | file | `prompt-template/codex/full-alignment-review.md` | 4156 | prompt/block template defining algorithmic transitions, gates, or review contracts |
