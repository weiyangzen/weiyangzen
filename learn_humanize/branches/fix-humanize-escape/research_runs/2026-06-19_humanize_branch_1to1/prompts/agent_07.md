...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-007 | file | `README.md` | 3332 | behavior-defining documentation for workflow/state-machine algorithms |
| FIX_HUMANIZE_ESCAPE-HZ-037 | file | `tests/test-plan-file-validation.sh` | 22731 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-067 | file | `prompt-template/block/work-summary-missing.md` | 335 | prompt/block template defining algorithmic transitions, gates, or review contracts |
