...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-010 | directory | `prompt-template/claude` | 4385 | directory contains included core algorithm descendant(s) |
| FIX_HUMANIZE_ESCAPE-HZ-040 | file | `tests/test-template-references.sh` | 7095 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-070 | file | `prompt-template/block/wrong-round-file.md` | 343 | prompt/block template defining algorithmic transitions, gates, or review contracts |
