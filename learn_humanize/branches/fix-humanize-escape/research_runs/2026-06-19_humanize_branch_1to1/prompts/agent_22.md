...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-022 | file | `scripts/humanize.sh` | 35827 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| FIX_HUMANIZE_ESCAPE-HZ-052 | file | `prompt-template/block/git-push.md` | 270 | prompt/block template defining algorithmic transitions, gates, or review contracts |
