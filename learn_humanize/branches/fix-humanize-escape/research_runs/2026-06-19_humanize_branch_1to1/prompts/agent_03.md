...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-003 | directory | `hooks` | 116570 | directory contains included core algorithm descendant(s) |
| FIX_HUMANIZE_ESCAPE-HZ-033 | file | `tests/test-humanize-escape.sh` | 12115 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-063 | file | `prompt-template/block/state-file-modification.md` | 238 | prompt/block template defining algorithmic transitions, gates, or review contracts |
