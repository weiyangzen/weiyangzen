...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-002 | directory | `commands` | 5465 | directory contains included core algorithm descendant(s) |
| FIX_HUMANIZE_ESCAPE-HZ-032 | file | `tests/test-finalize-phase.sh` | 23200 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-062 | file | `prompt-template/block/schema-outdated.md` | 394 | prompt/block template defining algorithmic transitions, gates, or review contracts |
