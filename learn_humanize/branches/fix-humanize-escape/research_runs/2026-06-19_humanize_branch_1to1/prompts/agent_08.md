...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-008 | directory | `hooks/lib` | 31331 | directory contains included core algorithm descendant(s) |
| FIX_HUMANIZE_ESCAPE-HZ-038 | file | `tests/test-state-exit-naming.sh` | 8959 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-068 | file | `prompt-template/block/wrong-directory-path.md` | 152 | prompt/block template defining algorithmic transitions, gates, or review contracts |
