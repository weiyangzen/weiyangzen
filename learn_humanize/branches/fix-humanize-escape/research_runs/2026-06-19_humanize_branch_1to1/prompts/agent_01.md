...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-001 | directory | `.` | 485878 | directory contains included core algorithm descendant(s) |
| FIX_HUMANIZE_ESCAPE-HZ-031 | file | `tests/test-error-scenarios.sh` | 7691 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-061 | file | `prompt-template/block/prompt-file-write.md` | 413 | prompt/block template defining algorithmic transitions, gates, or review contracts |
