...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-015 | file | `hooks/hooks.json` | 1402 | hook or validator implementation for the RLCR state machine |
| FIX_HUMANIZE_ESCAPE-HZ-045 | file | `hooks/lib/template-loader.sh` | 7114 | hook or validator implementation for the RLCR state machine |
| FIX_HUMANIZE_ESCAPE-HZ-075 | file | `prompt-template/claude/next-round-footer.md` | 465 | prompt/block template defining algorithmic transitions, gates, or review contracts |
