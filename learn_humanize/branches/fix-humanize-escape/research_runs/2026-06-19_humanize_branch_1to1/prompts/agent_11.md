...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-011 | directory | `prompt-template/codex` | 9101 | directory contains included core algorithm descendant(s) |
| FIX_HUMANIZE_ESCAPE-HZ-041 | file | `tests/test-templates-comprehensive.sh` | 19978 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-071 | file | `prompt-template/block/wrong-round-number.md` | 225 | prompt/block template defining algorithmic transitions, gates, or review contracts |
