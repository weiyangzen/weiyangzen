...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-026 | file | `tests/run-all-tests.sh` | 3665 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-056 | file | `prompt-template/block/goal-tracker-not-initialized.md` | 707 | prompt/block template defining algorithmic transitions, gates, or review contracts |
