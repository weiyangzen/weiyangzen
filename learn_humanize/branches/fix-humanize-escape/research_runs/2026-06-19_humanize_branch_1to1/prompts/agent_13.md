...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-013 | file | `commands/start-rlcr-loop.md` | 2410 | command workflow definition for plan/RLCR algorithms |
| FIX_HUMANIZE_ESCAPE-HZ-043 | file | `tests/test-zsh-monitor-safety.sh` | 10748 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-073 | file | `prompt-template/claude/finalize-phase-prompt.md` | 1650 | prompt/block template defining algorithmic transitions, gates, or review contracts |
