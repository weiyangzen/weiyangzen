...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-004 | directory | `prompt-template` | 24525 | directory contains included core algorithm descendant(s) |
| FIX_HUMANIZE_ESCAPE-HZ-034 | file | `tests/test-monitor-e2e-real.sh` | 11060 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-064 | file | `prompt-template/block/summary-bash-write.md` | 302 | prompt/block template defining algorithmic transitions, gates, or review contracts |
