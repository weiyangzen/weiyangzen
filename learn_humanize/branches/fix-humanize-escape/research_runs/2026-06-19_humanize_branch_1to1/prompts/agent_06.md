...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-006 | directory | `tests` | 273404 | directory contains included core algorithm descendant(s) |
| FIX_HUMANIZE_ESCAPE-HZ-036 | file | `tests/test-plan-file-hooks.sh` | 34778 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-066 | file | `prompt-template/block/unpushed-commits.md` | 348 | prompt/block template defining algorithmic transitions, gates, or review contracts |
