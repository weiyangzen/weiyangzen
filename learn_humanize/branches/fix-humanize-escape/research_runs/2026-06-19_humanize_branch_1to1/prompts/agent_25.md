...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-025 | file | `tests/manual-monitor-test.sh` | 2573 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-055 | file | `prompt-template/block/goal-tracker-modification.md` | 792 | prompt/block template defining algorithmic transitions, gates, or review contracts |
