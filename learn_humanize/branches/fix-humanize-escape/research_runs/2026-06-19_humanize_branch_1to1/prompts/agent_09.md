...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-009 | directory | `prompt-template/block` | 11039 | directory contains included core algorithm descendant(s) |
| FIX_HUMANIZE_ESCAPE-HZ-039 | file | `tests/test-template-loader.sh` | 21290 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-069 | file | `prompt-template/block/wrong-file-location.md` | 318 | prompt/block template defining algorithmic transitions, gates, or review contracts |
