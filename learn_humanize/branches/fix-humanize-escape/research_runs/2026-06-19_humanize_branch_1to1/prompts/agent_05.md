...
|---|---|---:|---:|---|
| FIX_HUMANIZE_ESCAPE-HZ-005 | directory | `scripts` | 62582 | directory contains included core algorithm descendant(s) |
| FIX_HUMANIZE_ESCAPE-HZ-035 | file | `tests/test-monitor-runtime.sh` | 8952 | executable specification for core algorithm behavior |
| FIX_HUMANIZE_ESCAPE-HZ-065 | file | `prompt-template/block/todos-file-access.md` | 253 | prompt/block template defining algorithmic transitions, gates, or review contracts |
