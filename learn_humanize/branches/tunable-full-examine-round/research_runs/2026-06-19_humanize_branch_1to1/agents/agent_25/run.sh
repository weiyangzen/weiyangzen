...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=running\nstarted_utc=%s\n' "$BRANCH" "$AGENT" '67aa7bab09f0d0e36ac403264eed6989b09aada5' '963d7c2de33adb281d457398c9498e54b9c36e7b' 'gpt-5.5' 'xhigh' 4 "$STARTED" > "$META"
set +e
...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=%s\nstarted_utc=%s\nended_utc=%s\nexit_code=%s\n' "$BRANCH" "$AGENT" '67aa7bab09f0d0e36ac403264eed6989b09aada5' '963d7c2de33adb281d457398c9498e54b9c36e7b' 'gpt-5.5' 'xhigh' 4 "$final_status" "$STARTED" "$ENDED" "$rc" > "$META"
exit "$rc"
