...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-021 | file | `hooks/loop-write-validator.sh` | 6368 | hook or validator implementation for the RLCR state machine |
| IMPROVE_MONITOR_SCRIPT-HZ-051 | file | `prompt-template/block/plan-file-modified.md` | 383 | prompt/block template defining algorithmic transitions, gates, or review contracts |
