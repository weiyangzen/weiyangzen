...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-017 | file | `hooks/loop-codex-stop-hook.sh` | 37108 | hook or validator implementation for the RLCR state machine |
| IMPROVE_MONITOR_SCRIPT-HZ-047 | file | `prompt-template/block/goal-tracker-not-initialized.md` | 707 | prompt/block template defining algorithmic transitions, gates, or review contracts |
