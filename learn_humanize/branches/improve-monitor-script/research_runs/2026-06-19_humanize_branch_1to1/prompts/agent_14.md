...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-014 | file | `hooks/check-todos-from-transcript.py` | 4496 | hook or validator implementation for the RLCR state machine |
| IMPROVE_MONITOR_SCRIPT-HZ-044 | file | `prompt-template/block/git-status-failed.md` | 326 | prompt/block template defining algorithmic transitions, gates, or review contracts |
