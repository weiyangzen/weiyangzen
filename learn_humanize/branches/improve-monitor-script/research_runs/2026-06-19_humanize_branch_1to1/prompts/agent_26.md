...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-026 | file | `tests/test-allowlist-validators.sh` | 14573 | executable specification for core algorithm behavior |
| IMPROVE_MONITOR_SCRIPT-HZ-056 | file | `prompt-template/block/todos-file-access.md` | 253 | prompt/block template defining algorithmic transitions, gates, or review contracts |
