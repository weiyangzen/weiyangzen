...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-005 | directory | `scripts` | 56399 | directory contains included core algorithm descendant(s) |
| IMPROVE_MONITOR_SCRIPT-HZ-035 | file | `tests/test-templates-comprehensive.sh` | 19978 | executable specification for core algorithm behavior |
| IMPROVE_MONITOR_SCRIPT-HZ-065 | file | `prompt-template/claude/next-round-footer.md` | 465 | prompt/block template defining algorithmic transitions, gates, or review contracts |
