...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-027 | file | `tests/test-ansi-parsing.sh` | 5801 | executable specification for core algorithm behavior |
| IMPROVE_MONITOR_SCRIPT-HZ-057 | file | `prompt-template/block/unpushed-commits.md` | 348 | prompt/block template defining algorithmic transitions, gates, or review contracts |
