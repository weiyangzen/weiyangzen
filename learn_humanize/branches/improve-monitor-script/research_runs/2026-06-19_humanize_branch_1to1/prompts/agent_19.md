...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-019 | file | `hooks/loop-plan-file-validator.sh` | 7671 | hook or validator implementation for the RLCR state machine |
| IMPROVE_MONITOR_SCRIPT-HZ-049 | file | `prompt-template/block/large-files.md` | 1088 | prompt/block template defining algorithmic transitions, gates, or review contracts |
