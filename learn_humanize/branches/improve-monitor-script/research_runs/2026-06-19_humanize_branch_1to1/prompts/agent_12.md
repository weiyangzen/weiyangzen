...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-012 | file | `commands/cancel-rlcr-loop.md` | 1311 | command workflow definition for plan/RLCR algorithms |
| IMPROVE_MONITOR_SCRIPT-HZ-042 | file | `prompt-template/block/git-not-clean.md` | 817 | prompt/block template defining algorithmic transitions, gates, or review contracts |
