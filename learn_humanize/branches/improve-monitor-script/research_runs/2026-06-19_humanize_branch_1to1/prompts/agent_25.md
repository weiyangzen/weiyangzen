...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-025 | file | `tests/run-all-tests.sh` | 2710 | executable specification for core algorithm behavior |
| IMPROVE_MONITOR_SCRIPT-HZ-055 | file | `prompt-template/block/summary-bash-write.md` | 302 | prompt/block template defining algorithmic transitions, gates, or review contracts |
