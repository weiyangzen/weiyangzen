...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-013 | file | `commands/start-rlcr-loop.md` | 2410 | command workflow definition for plan/RLCR algorithms |
| IMPROVE_MONITOR_SCRIPT-HZ-043 | file | `prompt-template/block/git-push.md` | 270 | prompt/block template defining algorithmic transitions, gates, or review contracts |
