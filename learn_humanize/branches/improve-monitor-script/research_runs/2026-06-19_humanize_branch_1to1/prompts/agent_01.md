...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-001 | directory | `.` | 344306 | directory contains included core algorithm descendant(s) |
| IMPROVE_MONITOR_SCRIPT-HZ-031 | file | `tests/test-plan-file-validation.sh` | 22731 | executable specification for core algorithm behavior |
| IMPROVE_MONITOR_SCRIPT-HZ-061 | file | `prompt-template/block/wrong-round-file.md` | 343 | prompt/block template defining algorithmic transitions, gates, or review contracts |
