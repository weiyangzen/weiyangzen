...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-029 | file | `tests/test-error-scenarios.sh` | 7691 | executable specification for core algorithm behavior |
| IMPROVE_MONITOR_SCRIPT-HZ-059 | file | `prompt-template/block/wrong-directory-path.md` | 152 | prompt/block template defining algorithmic transitions, gates, or review contracts |
