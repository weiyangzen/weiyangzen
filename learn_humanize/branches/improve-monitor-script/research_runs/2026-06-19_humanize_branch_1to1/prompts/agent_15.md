...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-015 | file | `hooks/hooks.json` | 1402 | hook or validator implementation for the RLCR state machine |
| IMPROVE_MONITOR_SCRIPT-HZ-045 | file | `prompt-template/block/goal-tracker-bash-write.md` | 289 | prompt/block template defining algorithmic transitions, gates, or review contracts |
