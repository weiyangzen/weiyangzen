...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-003 | directory | `hooks` | 90245 | directory contains included core algorithm descendant(s) |
| IMPROVE_MONITOR_SCRIPT-HZ-033 | file | `tests/test-template-loader.sh` | 21290 | executable specification for core algorithm behavior |
| IMPROVE_MONITOR_SCRIPT-HZ-063 | file | `prompt-template/block/wrong-summary-location.md` | 109 | prompt/block template defining algorithmic transitions, gates, or review contracts |
