...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-006 | directory | `tests` | 162577 | directory contains included core algorithm descendant(s) |
| IMPROVE_MONITOR_SCRIPT-HZ-036 | file | `tests/test-todo-checker.sh` | 10313 | executable specification for core algorithm behavior |
| IMPROVE_MONITOR_SCRIPT-HZ-066 | file | `prompt-template/claude/next-round-prompt.md` | 1206 | prompt/block template defining algorithmic transitions, gates, or review contracts |
