...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-022 | file | `scripts/humanize.sh` | 29644 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| IMPROVE_MONITOR_SCRIPT-HZ-052 | file | `prompt-template/block/prompt-file-write.md` | 413 | prompt/block template defining algorithmic transitions, gates, or review contracts |
