...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-016 | file | `hooks/loop-bash-validator.sh` | 4951 | hook or validator implementation for the RLCR state machine |
| IMPROVE_MONITOR_SCRIPT-HZ-046 | file | `prompt-template/block/goal-tracker-modification.md` | 792 | prompt/block template defining algorithmic transitions, gates, or review contracts |
