...
|---|---|---:|---:|---|
| IMPROVE_MONITOR_SCRIPT-HZ-002 | directory | `commands` | 3721 | directory contains included core algorithm descendant(s) |
| IMPROVE_MONITOR_SCRIPT-HZ-032 | file | `tests/test-state-exit-naming.sh` | 8959 | executable specification for core algorithm behavior |
| IMPROVE_MONITOR_SCRIPT-HZ-062 | file | `prompt-template/block/wrong-round-number.md` | 225 | prompt/block template defining algorithmic transitions, gates, or review contracts |
