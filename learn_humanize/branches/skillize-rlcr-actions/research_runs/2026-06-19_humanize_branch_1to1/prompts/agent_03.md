...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-003 | directory | `hooks` | 116570 | directory contains included core algorithm descendant(s) |
| SKILLIZE_RLCR_ACTIONS-HZ-033 | file | `tests/test-cancel-signal-file.sh` | 41224 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-063 | file | `prompt-template/block/incomplete-todos.md` | 442 | prompt/block template defining algorithmic transitions, gates, or review contracts |
