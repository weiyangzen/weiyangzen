...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-019 | file | `hooks/loop-bash-validator.sh` | 13540 | hook or validator implementation for the RLCR state machine |
| SKILLIZE_RLCR_ACTIONS-HZ-049 | file | `tests/test-zsh-monitor-safety.sh` | 10748 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-079 | file | `prompt-template/claude/finalize-phase-prompt.md` | 1650 | prompt/block template defining algorithmic transitions, gates, or review contracts |
