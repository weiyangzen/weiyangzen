...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-015 | file | `commands/cancel-rlcr-loop.md` | 398 | command workflow definition for plan/RLCR algorithms |
| SKILLIZE_RLCR_ACTIONS-HZ-045 | file | `tests/test-template-loader.sh` | 21290 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-075 | file | `prompt-template/block/wrong-file-location.md` | 318 | prompt/block template defining algorithmic transitions, gates, or review contracts |
