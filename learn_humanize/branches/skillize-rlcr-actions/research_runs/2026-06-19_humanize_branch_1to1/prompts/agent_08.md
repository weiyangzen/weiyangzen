...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-008 | file | `README.md` | 3332 | behavior-defining documentation for workflow/state-machine algorithms |
| SKILLIZE_RLCR_ACTIONS-HZ-038 | file | `tests/test-monitor-e2e-real.sh` | 11060 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-068 | file | `prompt-template/block/schema-outdated.md` | 394 | prompt/block template defining algorithmic transitions, gates, or review contracts |
