...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-002 | directory | `commands` | 977 | directory contains included core algorithm descendant(s) |
| SKILLIZE_RLCR_ACTIONS-HZ-032 | file | `tests/test-bash-validator-patterns.sh` | 6658 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-062 | file | `prompt-template/block/goal-tracker-not-initialized.md` | 707 | prompt/block template defining algorithmic transitions, gates, or review contracts |
