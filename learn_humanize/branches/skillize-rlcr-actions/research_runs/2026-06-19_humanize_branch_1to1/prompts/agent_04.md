...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-004 | directory | `prompt-template` | 24525 | directory contains included core algorithm descendant(s) |
| SKILLIZE_RLCR_ACTIONS-HZ-034 | file | `tests/test-error-scenarios.sh` | 7691 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-064 | file | `prompt-template/block/large-files.md` | 1088 | prompt/block template defining algorithmic transitions, gates, or review contracts |
