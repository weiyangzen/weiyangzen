...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-028 | file | `tests/manual-monitor-test.sh` | 2573 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-058 | file | `prompt-template/block/git-push.md` | 270 | prompt/block template defining algorithmic transitions, gates, or review contracts |
| SKILLIZE_RLCR_ACTIONS-HZ-088 | file | `skills/cancel-rlcr-loop/SKILL.md` | 3216 | skill instruction defining algorithmic workflow behavior |
