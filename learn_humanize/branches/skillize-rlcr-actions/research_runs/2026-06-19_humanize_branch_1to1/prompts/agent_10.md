...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-010 | directory | `prompt-template/block` | 11039 | directory contains included core algorithm descendant(s) |
| SKILLIZE_RLCR_ACTIONS-HZ-040 | file | `tests/test-plan-file-hooks.sh` | 34778 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-070 | file | `prompt-template/block/summary-bash-write.md` | 302 | prompt/block template defining algorithmic transitions, gates, or review contracts |
