...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-007 | directory | `tests` | 330300 | directory contains included core algorithm descendant(s) |
| SKILLIZE_RLCR_ACTIONS-HZ-037 | file | `tests/test-humanize-escape.sh` | 12115 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-067 | file | `prompt-template/block/prompt-file-write.md` | 413 | prompt/block template defining algorithmic transitions, gates, or review contracts |
