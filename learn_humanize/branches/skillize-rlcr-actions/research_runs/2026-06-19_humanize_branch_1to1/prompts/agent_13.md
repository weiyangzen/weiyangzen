...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-013 | directory | `skills/cancel-rlcr-loop` | 3216 | directory contains included core algorithm descendant(s) |
| SKILLIZE_RLCR_ACTIONS-HZ-043 | file | `tests/test-skill-structure.sh` | 21681 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-073 | file | `prompt-template/block/work-summary-missing.md` | 335 | prompt/block template defining algorithmic transitions, gates, or review contracts |
