...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-001 | directory | `.` | 543959 | directory contains included core algorithm descendant(s) |
| SKILLIZE_RLCR_ACTIONS-HZ-031 | file | `tests/test-ansi-parsing.sh` | 5801 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-061 | file | `prompt-template/block/goal-tracker-modification.md` | 792 | prompt/block template defining algorithmic transitions, gates, or review contracts |
