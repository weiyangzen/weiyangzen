...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-014 | directory | `skills/start-rlcr-loop` | 2457 | directory contains included core algorithm descendant(s) |
| SKILLIZE_RLCR_ACTIONS-HZ-044 | file | `tests/test-state-exit-naming.sh` | 8959 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-074 | file | `prompt-template/block/wrong-directory-path.md` | 152 | prompt/block template defining algorithmic transitions, gates, or review contracts |
