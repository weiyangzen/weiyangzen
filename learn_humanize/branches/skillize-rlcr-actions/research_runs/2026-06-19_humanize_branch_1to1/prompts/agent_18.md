...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-018 | file | `hooks/hooks.json` | 1402 | hook or validator implementation for the RLCR state machine |
| SKILLIZE_RLCR_ACTIONS-HZ-048 | file | `tests/test-todo-checker.sh` | 10313 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-078 | file | `prompt-template/block/wrong-summary-location.md` | 109 | prompt/block template defining algorithmic transitions, gates, or review contracts |
