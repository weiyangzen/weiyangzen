...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-017 | file | `hooks/check-todos-from-transcript.py` | 4496 | hook or validator implementation for the RLCR state machine |
| SKILLIZE_RLCR_ACTIONS-HZ-047 | file | `tests/test-templates-comprehensive.sh` | 19978 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-077 | file | `prompt-template/block/wrong-round-number.md` | 225 | prompt/block template defining algorithmic transitions, gates, or review contracts |
