...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-011 | directory | `prompt-template/claude` | 4385 | directory contains included core algorithm descendant(s) |
| SKILLIZE_RLCR_ACTIONS-HZ-041 | file | `tests/test-plan-file-validation.sh` | 22731 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-071 | file | `prompt-template/block/todos-file-access.md` | 253 | prompt/block template defining algorithmic transitions, gates, or review contracts |
