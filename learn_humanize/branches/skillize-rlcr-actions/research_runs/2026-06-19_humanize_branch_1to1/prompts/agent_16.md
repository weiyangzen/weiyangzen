...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-016 | file | `commands/start-rlcr-loop.md` | 579 | command workflow definition for plan/RLCR algorithms |
| SKILLIZE_RLCR_ACTIONS-HZ-046 | file | `tests/test-template-references.sh` | 7095 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-076 | file | `prompt-template/block/wrong-round-file.md` | 343 | prompt/block template defining algorithmic transitions, gates, or review contracts |
