...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-009 | directory | `hooks/lib` | 31331 | directory contains included core algorithm descendant(s) |
| SKILLIZE_RLCR_ACTIONS-HZ-039 | file | `tests/test-monitor-runtime.sh` | 8952 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-069 | file | `prompt-template/block/state-file-modification.md` | 238 | prompt/block template defining algorithmic transitions, gates, or review contracts |
