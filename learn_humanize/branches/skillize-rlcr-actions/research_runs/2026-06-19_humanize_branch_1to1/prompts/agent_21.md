...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-021 | file | `hooks/loop-edit-validator.sh` | 4887 | hook or validator implementation for the RLCR state machine |
| SKILLIZE_RLCR_ACTIONS-HZ-051 | file | `hooks/lib/template-loader.sh` | 7114 | hook or validator implementation for the RLCR state machine |
| SKILLIZE_RLCR_ACTIONS-HZ-081 | file | `prompt-template/claude/next-round-footer.md` | 465 | prompt/block template defining algorithmic transitions, gates, or review contracts |
