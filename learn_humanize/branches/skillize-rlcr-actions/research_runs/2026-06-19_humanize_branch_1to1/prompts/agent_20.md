...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-020 | file | `hooks/loop-codex-stop-hook.sh` | 40784 | hook or validator implementation for the RLCR state machine |
| SKILLIZE_RLCR_ACTIONS-HZ-050 | file | `hooks/lib/loop-common.sh` | 24217 | hook or validator implementation for the RLCR state machine |
| SKILLIZE_RLCR_ACTIONS-HZ-080 | file | `prompt-template/claude/goal-tracker-update-request.md` | 573 | prompt/block template defining algorithmic transitions, gates, or review contracts |
