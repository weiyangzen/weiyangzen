...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-006 | directory | `skills` | 5673 | directory contains included core algorithm descendant(s) |
| SKILLIZE_RLCR_ACTIONS-HZ-036 | file | `tests/test-hook-preservation.sh` | 20567 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-066 | file | `prompt-template/block/plan-file-modified.md` | 383 | prompt/block template defining algorithmic transitions, gates, or review contracts |
