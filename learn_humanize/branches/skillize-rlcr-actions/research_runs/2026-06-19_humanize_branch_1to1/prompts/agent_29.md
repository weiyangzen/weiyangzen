...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-029 | file | `tests/run-all-tests.sh` | 3758 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-059 | file | `prompt-template/block/git-status-failed.md` | 326 | prompt/block template defining algorithmic transitions, gates, or review contracts |
| SKILLIZE_RLCR_ACTIONS-HZ-089 | file | `skills/start-rlcr-loop/SKILL.md` | 2457 | skill instruction defining algorithmic workflow behavior |
