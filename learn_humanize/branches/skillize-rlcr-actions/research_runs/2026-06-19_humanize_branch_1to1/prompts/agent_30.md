...
|---|---|---:|---:|---|
| SKILLIZE_RLCR_ACTIONS-HZ-030 | file | `tests/test-allowlist-validators.sh` | 14573 | executable specification for core algorithm behavior |
| SKILLIZE_RLCR_ACTIONS-HZ-060 | file | `prompt-template/block/goal-tracker-bash-write.md` | 289 | prompt/block template defining algorithmic transitions, gates, or review contracts |
