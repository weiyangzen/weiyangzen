...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=running\nstarted_utc=%s\n' "$BRANCH" "$AGENT" '0a9187b8478dd3ed9c0cf58a4615c61e188fd444' 'a2958058fd3ea9d4b6696ac43abf190a760266cb' 'gpt-5.5' 'xhigh' 2 "$STARTED" > "$META"
set +e
...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=%s\nstarted_utc=%s\nended_utc=%s\nexit_code=%s\n' "$BRANCH" "$AGENT" '0a9187b8478dd3ed9c0cf58a4615c61e188fd444' 'a2958058fd3ea9d4b6696ac43abf190a760266cb' 'gpt-5.5' 'xhigh' 2 "$final_status" "$STARTED" "$ENDED" "$rc" > "$META"
exit "$rc"
