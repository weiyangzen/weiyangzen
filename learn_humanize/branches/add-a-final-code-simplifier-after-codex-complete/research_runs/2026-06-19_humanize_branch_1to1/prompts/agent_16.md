...
|---|---|---:|---:|---|
| ADD_A_FINAL_CODE_SIMPLIFIER_AFTER_CODEX_COMPLETE-HZ-016 | file | `hooks/loop-bash-validator.sh` | 12682 | hook or validator implementation for the RLCR state machine |
| ADD_A_FINAL_CODE_SIMPLIFIER_AFTER_CODEX_COMPLETE-HZ-046 | file | `prompt-template/block/git-push.md` | 270 | prompt/block template defining algorithmic transitions, gates, or review contracts |
