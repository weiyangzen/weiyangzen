...
|---|---|---:|---:|---|
| ADD_A_FINAL_CODE_SIMPLIFIER_AFTER_CODEX_COMPLETE-HZ-005 | directory | `scripts` | 56399 | directory contains included core algorithm descendant(s) |
| ADD_A_FINAL_CODE_SIMPLIFIER_AFTER_CODEX_COMPLETE-HZ-035 | file | `tests/test-template-loader.sh` | 21290 | executable specification for core algorithm behavior |
| ADD_A_FINAL_CODE_SIMPLIFIER_AFTER_CODEX_COMPLETE-HZ-065 | file | `prompt-template/block/wrong-round-number.md` | 225 | prompt/block template defining algorithmic transitions, gates, or review contracts |
