...
|---|---|---:|---:|---|
| ADD_A_FINAL_CODE_SIMPLIFIER_AFTER_CODEX_COMPLETE-HZ-022 | file | `scripts/humanize.sh` | 29644 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| ADD_A_FINAL_CODE_SIMPLIFIER_AFTER_CODEX_COMPLETE-HZ-052 | file | `prompt-template/block/large-files.md` | 1088 | prompt/block template defining algorithmic transitions, gates, or review contracts |
