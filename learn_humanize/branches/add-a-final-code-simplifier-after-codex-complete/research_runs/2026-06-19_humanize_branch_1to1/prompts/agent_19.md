...
|---|---|---:|---:|---|
| ADD_A_FINAL_CODE_SIMPLIFIER_AFTER_CODEX_COMPLETE-HZ-019 | file | `hooks/loop-plan-file-validator.sh` | 7833 | hook or validator implementation for the RLCR state machine |
| ADD_A_FINAL_CODE_SIMPLIFIER_AFTER_CODEX_COMPLETE-HZ-049 | file | `prompt-template/block/goal-tracker-modification.md` | 792 | prompt/block template defining algorithmic transitions, gates, or review contracts |
