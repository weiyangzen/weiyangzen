...
|---|---|---:|---:|---|
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-012 | directory | `prompt-template/codex` | 9101 | directory contains included core algorithm descendant(s) |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-042 | file | `tests/test-monitor-e2e-real.sh` | 11182 | executable specification for core algorithm behavior |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-072 | file | `prompt-template/block/summary-bash-write.md` | 302 | prompt/block template defining algorithmic transitions, gates, or review contracts |
