...
|---|---|---:|---:|---|
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-016 | file | `commands/gen-plan.md` | 8314 | command workflow definition for plan/RLCR algorithms |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-046 | file | `tests/test-state-exit-naming.sh` | 8959 | executable specification for core algorithm behavior |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-076 | file | `prompt-template/block/wrong-directory-path.md` | 152 | prompt/block template defining algorithmic transitions, gates, or review contracts |
