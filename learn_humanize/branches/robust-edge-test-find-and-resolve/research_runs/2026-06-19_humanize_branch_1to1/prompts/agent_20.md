...
|---|---|---:|---:|---|
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-020 | file | `hooks/loop-bash-validator.sh` | 13951 | hook or validator implementation for the RLCR state machine |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-050 | file | `tests/test-todo-checker.sh` | 10313 | executable specification for core algorithm behavior |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-080 | file | `prompt-template/block/wrong-summary-location.md` | 109 | prompt/block template defining algorithmic transitions, gates, or review contracts |
