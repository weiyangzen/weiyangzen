...
|---|---|---:|---:|---|
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-017 | file | `commands/start-rlcr-loop.md` | 2410 | command workflow definition for plan/RLCR algorithms |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-047 | file | `tests/test-template-loader.sh` | 21290 | executable specification for core algorithm behavior |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-077 | file | `prompt-template/block/wrong-file-location.md` | 318 | prompt/block template defining algorithmic transitions, gates, or review contracts |
