...
|---|---|---:|---:|---|
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-011 | directory | `prompt-template/claude` | 4385 | directory contains included core algorithm descendant(s) |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-041 | file | `tests/test-humanize-escape.sh` | 12115 | executable specification for core algorithm behavior |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-071 | file | `prompt-template/block/state-file-modification.md` | 238 | prompt/block template defining algorithmic transitions, gates, or review contracts |
