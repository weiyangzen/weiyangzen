...
|---|---|---:|---:|---|
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-010 | directory | `prompt-template/block` | 11039 | directory contains included core algorithm descendant(s) |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-040 | file | `tests/test-helpers.sh` | 2594 | executable specification for core algorithm behavior |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-070 | file | `prompt-template/block/schema-outdated.md` | 394 | prompt/block template defining algorithmic transitions, gates, or review contracts |
