...
|---|---|---:|---:|---|
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-018 | file | `hooks/check-todos-from-transcript.py` | 4496 | hook or validator implementation for the RLCR state machine |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-048 | file | `tests/test-template-references.sh` | 7095 | executable specification for core algorithm behavior |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-078 | file | `prompt-template/block/wrong-round-file.md` | 343 | prompt/block template defining algorithmic transitions, gates, or review contracts |
