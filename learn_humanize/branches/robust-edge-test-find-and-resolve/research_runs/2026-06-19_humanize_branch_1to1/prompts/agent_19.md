...
|---|---|---:|---:|---|
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-019 | file | `hooks/hooks.json` | 1402 | hook or validator implementation for the RLCR state machine |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-049 | file | `tests/test-templates-comprehensive.sh` | 19978 | executable specification for core algorithm behavior |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-079 | file | `prompt-template/block/wrong-round-number.md` | 225 | prompt/block template defining algorithmic transitions, gates, or review contracts |
