...
|---|---|---:|---:|---|
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-027 | file | `scripts/humanize.sh` | 37239 | runtime script implementing workflow, routing, monitor, validation, or state behavior |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-057 | file | `prompt-template/block/git-not-clean-humanize-local.md` | 237 | prompt/block template defining algorithmic transitions, gates, or review contracts |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-087 | file | `prompt-template/codex/full-alignment-review.md` | 4156 | prompt/block template defining algorithmic transitions, gates, or review contracts |
