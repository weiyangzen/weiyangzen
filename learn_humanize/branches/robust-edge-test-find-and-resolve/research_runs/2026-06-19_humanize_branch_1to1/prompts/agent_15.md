...
|---|---|---:|---:|---|
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-015 | file | `commands/cancel-rlcr-loop.md` | 1914 | command workflow definition for plan/RLCR algorithms |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-045 | file | `tests/test-plan-file-validation.sh` | 22731 | executable specification for core algorithm behavior |
| ROBUST_EDGE_TEST_FIND_AND_RESOLVE-HZ-075 | file | `prompt-template/block/work-summary-missing.md` | 335 | prompt/block template defining algorithmic transitions, gates, or review contracts |
