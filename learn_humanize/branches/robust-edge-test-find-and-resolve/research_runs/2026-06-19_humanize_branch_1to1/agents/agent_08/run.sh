...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=running\nstarted_utc=%s\n' "$BRANCH" "$AGENT" 'a3112ca4d149f56ced783e805b6dfcf029368dc4' 'a5790de8b3fc8edc56d0b302e556cb4f2cf234ae' 'gpt-5.5' 'xhigh' 4 "$STARTED" > "$META"
set +e
...
printf 'branch=%s\nagent=%s\nsource_commit=%s\nsource_tree=%s\nmodel=%s\nreasoning_effort=%s\nitem_count=%s\nstatus=%s\nstarted_utc=%s\nended_utc=%s\nexit_code=%s\n' "$BRANCH" "$AGENT" 'a3112ca4d149f56ced783e805b6dfcf029368dc4' 'a5790de8b3fc8edc56d0b302e556cb4f2cf234ae' 'gpt-5.5' 'xhigh' 4 "$final_status" "$STARTED" "$ENDED" "$rc" > "$META"
exit "$rc"
