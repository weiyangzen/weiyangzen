...
|---|---|---:|---:|---|
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-021 | file | `hooks/loop-codex-stop-hook.sh` | 41081 | hook or validator implementation for the RLCR state machine |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-051 | file | `tests/test-zsh-monitor-safety.sh` | 10681 | executable specification for core algorithm behavior |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-081 | file | `prompt-template/claude/finalize-phase-prompt.md` | 1650 | prompt/block template defining algorithmic transitions, gates, or review contracts |
