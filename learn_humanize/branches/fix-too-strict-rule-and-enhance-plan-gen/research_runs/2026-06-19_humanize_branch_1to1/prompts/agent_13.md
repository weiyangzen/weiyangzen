...
|---|---|---:|---:|---|
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-013 | directory | `tests/robustness` | 131274 | directory contains included core algorithm descendant(s) |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-043 | file | `tests/test-monitor-runtime.sh` | 8952 | executable specification for core algorithm behavior |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-073 | file | `prompt-template/block/todos-file-access.md` | 253 | prompt/block template defining algorithmic transitions, gates, or review contracts |
