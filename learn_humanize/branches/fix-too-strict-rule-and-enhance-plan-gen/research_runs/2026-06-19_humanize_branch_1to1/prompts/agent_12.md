...
|---|---|---:|---:|---|
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-012 | directory | `prompt-template/codex` | 9101 | directory contains included core algorithm descendant(s) |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-042 | file | `tests/test-monitor-e2e-real.sh` | 11182 | executable specification for core algorithm behavior |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-072 | file | `prompt-template/block/summary-bash-write.md` | 302 | prompt/block template defining algorithmic transitions, gates, or review contracts |
