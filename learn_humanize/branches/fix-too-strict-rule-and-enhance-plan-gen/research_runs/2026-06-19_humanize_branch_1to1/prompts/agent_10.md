...
|---|---|---:|---:|---|
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-010 | directory | `prompt-template/block` | 11401 | directory contains included core algorithm descendant(s) |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-040 | file | `tests/test-helpers.sh` | 2594 | executable specification for core algorithm behavior |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-070 | file | `prompt-template/block/schema-outdated.md` | 394 | prompt/block template defining algorithmic transitions, gates, or review contracts |
