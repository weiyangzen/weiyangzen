...
|---|---|---:|---:|---|
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-005 | directory | `prompt-template` | 24887 | directory contains included core algorithm descendant(s) |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-035 | file | `tests/test-bash-validator-patterns.sh` | 6658 | executable specification for core algorithm behavior |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-065 | file | `prompt-template/block/incomplete-todos.md` | 442 | prompt/block template defining algorithmic transitions, gates, or review contracts |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-095 | file | `tests/robustness/test-plan-file-robustness.sh` | 14639 | executable specification for core algorithm behavior |
