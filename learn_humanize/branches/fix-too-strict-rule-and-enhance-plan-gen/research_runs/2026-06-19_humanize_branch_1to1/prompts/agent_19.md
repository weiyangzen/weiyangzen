...
|---|---|---:|---:|---|
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-019 | file | `hooks/hooks.json` | 1402 | hook or validator implementation for the RLCR state machine |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-049 | file | `tests/test-templates-comprehensive.sh` | 19978 | executable specification for core algorithm behavior |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-079 | file | `prompt-template/block/wrong-round-number.md` | 225 | prompt/block template defining algorithmic transitions, gates, or review contracts |
