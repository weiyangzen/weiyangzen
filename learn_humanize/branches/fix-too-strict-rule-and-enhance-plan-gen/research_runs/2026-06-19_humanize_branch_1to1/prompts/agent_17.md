...
|---|---|---:|---:|---|
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-017 | file | `commands/start-rlcr-loop.md` | 2410 | command workflow definition for plan/RLCR algorithms |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-047 | file | `tests/test-template-loader.sh` | 21290 | executable specification for core algorithm behavior |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-077 | file | `prompt-template/block/wrong-file-location.md` | 318 | prompt/block template defining algorithmic transitions, gates, or review contracts |
