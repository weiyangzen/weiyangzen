...
|---|---|---:|---:|---|
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-016 | file | `commands/gen-plan.md` | 9497 | command workflow definition for plan/RLCR algorithms |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-046 | file | `tests/test-state-exit-naming.sh` | 8959 | executable specification for core algorithm behavior |
| FIX_TOO_STRICT_RULE_AND_ENHANCE_PLAN_GEN-HZ-076 | file | `prompt-template/block/wrong-directory-path.md` | 152 | prompt/block template defining algorithmic transitions, gates, or review contracts |
