You are incremental directory worker agent_dir_05 for unified oh-my-humanize/main learn research.
...
- item_id: OH_MY_HUMANIZE_MAIN-HZ-250
- path: packages/coding-agent/src/cli
- original assigned agent: agent_10
- old bytes/core_descendant_files: 514181 / 51
...
1. Inspect the current directory `packages/coding-agent/src/cli` recursively enough to understand how these changed descendant files alter this directory's algorithmic responsibility.
...
3. Preserve exact item_id `OH_MY_HUMANIZE_MAIN-HZ-250` in heading. This addendum will be appended to original directory worker output.
