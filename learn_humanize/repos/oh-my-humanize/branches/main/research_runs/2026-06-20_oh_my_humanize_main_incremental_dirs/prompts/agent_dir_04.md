You are incremental directory worker agent_dir_04 for unified oh-my-humanize/main learn research.
...
- item_id: OH_MY_HUMANIZE_MAIN-HZ-133
- path: packages/coding-agent/src
- original assigned agent: agent_13
- old bytes/core_descendant_files: 11019191 / 980
...
1. Inspect the current directory `packages/coding-agent/src` recursively enough to understand how these changed descendant files alter this directory's algorithmic responsibility.
...
3. Preserve exact item_id `OH_MY_HUMANIZE_MAIN-HZ-133` in heading. This addendum will be appended to original directory worker output.
