You are incremental directory worker agent_dir_07 for unified oh-my-humanize/main learn research.
...
- item_id: OH_MY_HUMANIZE_MAIN-HZ-134
- path: packages/coding-agent/test
- original assigned agent: agent_14
- old bytes/core_descendant_files: 6585999 / 808
...
1. Inspect the current directory `packages/coding-agent/test` recursively enough to understand how these changed descendant files alter this directory's algorithmic responsibility.
...
3. Preserve exact item_id `OH_MY_HUMANIZE_MAIN-HZ-134` in heading. This addendum will be appended to original directory worker output.
