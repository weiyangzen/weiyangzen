You are incremental directory worker agent_dir_08 for unified oh-my-humanize/main learn research.
...
- item_id: OH_MY_HUMANIZE_MAIN-HZ-320
- path: packages/coding-agent/test/workflow
- original assigned agent: agent_20
- old bytes/core_descendant_files: 600548 / 26
...
1. Inspect the current directory `packages/coding-agent/test/workflow` recursively enough to understand how these changed descendant files alter this directory's algorithmic responsibility.
...
3. Preserve exact item_id `OH_MY_HUMANIZE_MAIN-HZ-320` in heading. This addendum will be appended to original directory worker output.
