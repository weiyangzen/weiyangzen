...
status=running
started_utc=%s
' "$AGENT" '0ec921a36b4365df503511c5567bbd3e02db0df5' 'gpt-5.5' 'xhigh' 6 "$STARTED" > "$META"
set +e
...
ended_utc=%s
exit_code=%s
' "$AGENT" '0ec921a36b4365df503511c5567bbd3e02db0df5' 'gpt-5.5' 'xhigh' 6 "$final_status" "$STARTED" "$ENDED" "$rc" > "$META"
exit "$rc"
